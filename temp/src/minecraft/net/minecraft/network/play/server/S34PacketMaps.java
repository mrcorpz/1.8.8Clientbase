...
public class S34PacketMaps implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148840_b(PacketBuffer p_148840_1_) throws IOException {
      ...
      for(Vec4b lvt_5_1_ : this.field_179740_c) {
   ...
   public void func_179734_a(MapData p_179734_1_) {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_179740_c.length; ++lvt_2_1_) {
         Vec4b lvt_3_1_ = this.field_179740_c[lvt_2_1_];
         p_179734_1_.field_76203_h.put("icon-" + lvt_2_1_, lvt_3_1_);
      }

      for(int lvt_2_2_ = 0; lvt_2_2_ < this.field_179735_f; ++lvt_2_2_) {
