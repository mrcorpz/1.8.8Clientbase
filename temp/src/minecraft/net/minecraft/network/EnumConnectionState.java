...
public enum EnumConnectionState {
   ...
   protected EnumConnectionState func_179245_a(EnumPacketDirection p_179245_1_, Class<? extends Packet> p_179245_2_) {
      ...
      if(lvt_3_1_.containsValue(p_179245_2_)) {
         String lvt_4_1_ = p_179245_1_ + " packet " + p_179245_2_ + " is already known to ID " + lvt_3_1_.inverse().get(p_179245_2_);
         LogManager.getLogger().fatal(lvt_4_1_);
         throw new IllegalArgumentException(lvt_4_1_);
      } else {
         lvt_3_1_.put(Integer.valueOf(lvt_3_1_.size()), p_179245_2_);
         return this;
      }
   }
   ...
   public Packet func_179244_a(EnumPacketDirection p_179244_1_, int p_179244_2_) throws InstantiationException, IllegalAccessException {
      Class<? extends Packet> lvt_3_1_ = (Class)((BiMap)this.field_179247_h.get(p_179244_1_)).get(Integer.valueOf(p_179244_2_));
      ...
      for(EnumConnectionState lvt_3_1_ : values()) {
         ...
         for(EnumPacketDirection lvt_6_1_ : lvt_3_1_.field_179247_h.keySet()) {
            for(Class<? extends Packet> lvt_8_1_ : ((BiMap)lvt_3_1_.field_179247_h.get(lvt_6_1_)).values()) {
               ...
               field_150761_f.put(lvt_8_1_, lvt_3_1_);
            }
         }
      }
