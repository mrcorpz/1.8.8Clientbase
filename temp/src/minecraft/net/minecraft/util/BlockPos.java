...
public class BlockPos extends Vec3i {
            ...
            return new AbstractIterator<BlockPos>() {
               ...
               protected BlockPos computeNext() {
                  if(this.field_179309_b == null) {
                     ...
                     int lvt_2_1_ = this.field_179309_b.func_177956_o();
                     int lvt_3_1_ = this.field_179309_b.func_177952_p();
                     if(lvt_1_1_ < lvt_3_1_.func_177958_n()) {
                        ++lvt_1_1_;
                     } else if(lvt_2_1_ < lvt_3_1_.func_177956_o()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                        ++lvt_2_1_;
                     } else if(lvt_3_1_ < lvt_3_1_.func_177952_p()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                        lvt_2_1_ = lvt_2_1_.func_177956_o();
                        ++lvt_3_1_;
                     }

                     this.field_179309_b = new BlockPos(lvt_1_1_, lvt_2_1_, lvt_3_1_);
                     return this.field_179309_b;
                  }
               }
            ...
            return new AbstractIterator<BlockPos.MutableBlockPos>() {
               ...
               protected BlockPos.MutableBlockPos computeNext() {
                  if(this.field_179314_b == null) {
                     ...
                     int lvt_2_1_ = this.field_179314_b.func_177956_o();
                     int lvt_3_1_ = this.field_179314_b.func_177952_p();
                     if(lvt_1_1_ < lvt_3_1_.func_177958_n()) {
                        ++lvt_1_1_;
                     } else if(lvt_2_1_ < lvt_3_1_.func_177956_o()) {
                        lvt_1_1_ = lvt_2_1_.func_177958_n();
                     ...
                     this.field_179314_b.field_177998_c = lvt_2_1_;
                     this.field_179314_b.field_177996_d = lvt_3_1_;
                     return this.field_179314_b;
                  }
               }
   ...
   public Vec3i func_177955_d(Vec3i p_177955_1_) {
      return this.func_177955_d(p_177955_1_);
   }
   ...
   public static final class MutableBlockPos extends BlockPos {
      ...
      // $FF: synthetic method
      public Vec3i func_177955_d(Vec3i p_177955_1_) {
         return super.func_177955_d(p_177955_1_);
      }
   }
}
