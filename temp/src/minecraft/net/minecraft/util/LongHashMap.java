...
public class LongHashMap<V> {
   ...
   public V func_76164_a(long p_76164_1_) {
      int lvt_3_1_ = func_76155_g(p_76164_1_);

      for(LongHashMap.Entry<V> lvt_4_1_ = this.field_76169_a[func_76158_a(lvt_3_1_, this.field_180201_c)]; lvt_4_1_ != null; lvt_4_1_ = lvt_4_1_.field_76149_c) {
         if(lvt_4_1_.field_76150_a == p_76164_1_) {
            return lvt_4_1_.field_76148_b;
         }
      }
   ...
   final LongHashMap.Entry<V> func_76160_c(long p_76160_1_) {
      int lvt_3_1_ = func_76155_g(p_76160_1_);

      for(LongHashMap.Entry<V> lvt_4_1_ = this.field_76169_a[func_76158_a(lvt_3_1_, this.field_180201_c)]; lvt_4_1_ != null; lvt_4_1_ = lvt_4_1_.field_76149_c) {
         if(lvt_4_1_.field_76150_a == p_76160_1_) {
            return lvt_4_1_;
         }
      }
   ...
   public void func_76163_a(long p_76163_1_, V p_76163_3_) {
      int lvt_4_1_ = func_76155_g(p_76163_1_);
      int lvt_5_1_ = func_76158_a(lvt_4_1_, this.field_180201_c);

      for(LongHashMap.Entry<V> lvt_6_1_ = this.field_76169_a[lvt_5_1_]; lvt_6_1_ != null; lvt_6_1_ = lvt_6_1_.field_76149_c) {
         if(lvt_6_1_.field_76150_a == p_76163_1_) {
            lvt_6_1_.field_76148_b = p_76163_3_;
            return;
         }
      }

      ++this.field_76166_e;
      this.func_76156_a(lvt_4_1_, p_76163_1_, p_76163_3_, lvt_5_1_);
   }

   private void func_76153_b(int p_76153_1_) {
      LongHashMap.Entry<V>[] lvt_2_1_ = this.field_76169_a;
      ...
      if(lvt_3_1_ == 1073741824) {
         ...
         this.func_76154_a(lvt_4_1_);
         this.field_76169_a = lvt_4_1_;
         this.field_180201_c = this.field_76169_a.length - 1;
   ...
   private void func_76154_a(LongHashMap.Entry<V>[] p_76154_1_) {
      ...
      for(int lvt_4_1_ = 0; lvt_4_1_ < lvt_2_1_.length; ++lvt_4_1_) {
         ...
         if(lvt_5_1_ != null) {
            ...
            while(true) {
               LongHashMap.Entry<V> lvt_6_1_ = lvt_5_1_.field_76149_c;
               int lvt_7_1_ = func_76158_a(lvt_5_1_.field_76147_d, lvt_3_1_ - 1);
               lvt_5_1_.field_76149_c = p_76154_1_[lvt_7_1_];
   ...
   public V func_76159_d(long p_76159_1_) {
      LongHashMap.Entry<V> lvt_3_1_ = this.func_76152_e(p_76159_1_);
      return (V)(lvt_3_1_ == null?null:lvt_3_1_.field_76148_b);
   }

   final LongHashMap.Entry<V> func_76152_e(long p_76152_1_) {
      int lvt_3_1_ = func_76155_g(p_76152_1_);
      int lvt_4_1_ = func_76158_a(lvt_3_1_, this.field_180201_c);
      LongHashMap.Entry<V> lvt_5_1_ = this.field_76169_a[lvt_4_1_];

      LongHashMap.Entry<V> lvt_6_1_;
      LongHashMap.Entry<V> lvt_7_1_;
      for(lvt_6_1_ = lvt_5_1_; lvt_6_1_ != null; lvt_6_1_ = lvt_7_1_) {
         lvt_7_1_ = lvt_6_1_.field_76149_c;
         if(lvt_6_1_.field_76150_a == p_76152_1_) {
            ++this.field_76166_e;
            --this.field_76167_b;
            if(lvt_5_1_ == lvt_6_1_) {
               this.field_76169_a[lvt_4_1_] = lvt_7_1_;
            } else {
               lvt_5_1_.field_76149_c = lvt_7_1_;
            }
   ...
   private void func_76156_a(int p_76156_1_, long p_76156_2_, V p_76156_4_, int p_76156_5_) {
      LongHashMap.Entry<V> lvt_6_1_ = this.field_76169_a[p_76156_5_];
      this.field_76169_a[p_76156_5_] = new LongHashMap.Entry(p_76156_1_, p_76156_2_, p_76156_4_, lvt_6_1_);
   ...
   static class Entry<V> {
      ...
      public final boolean equals(Object p_equals_1_) {
         if(!(p_equals_1_ instanceof LongHashMap.Entry)) {
            ...
            Object lvt_3_1_ = Long.valueOf(this.func_76146_a());
            Object lvt_4_1_ = Long.valueOf(lvt_2_1_.func_76146_a());
            if(lvt_3_1_ == lvt_4_1_ || lvt_3_1_ != null && lvt_3_1_.equals(lvt_4_1_)) {
               Object lvt_5_1_ = this.func_76145_b();
               Object lvt_6_1_ = lvt_2_1_.func_76145_b();
