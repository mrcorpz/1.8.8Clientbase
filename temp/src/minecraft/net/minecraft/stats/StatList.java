...
public class StatList {
   ...
   private static void func_75918_d() {
      ...
      for(IRecipe lvt_2_1_ : CraftingManager.func_77594_a().func_77592_b()) {
         if(lvt_2_1_.func_77571_b() != null) {
            lvt_0_1_.add(lvt_2_1_.func_77571_b().func_77973_b());
         }
      }

      for(ItemStack lvt_2_2_ : FurnaceRecipes.func_77602_a().func_77599_b().values()) {
   ...
   private static void func_75925_c() {
      for(Item lvt_1_1_ : Item.field_150901_e) {
         if(lvt_1_1_ != null) {
