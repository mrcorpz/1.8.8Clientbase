...
public class RecipesDyes {
   public void func_77607_a(CraftingManager p_77607_1_) {
      for(int lvt_2_1_ = 0; lvt_2_1_ < 16; ++lvt_2_1_) {
         p_77607_1_.func_77596_b(new ItemStack(Blocks.field_150325_L, 1, lvt_2_1_), new Object[]{new ItemStack(Items.field_151100_aR, 1, 15 - lvt_2_1_), new ItemStack(Item.func_150898_a(Blocks.field_150325_L), 1, 0)});
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150406_ce, 8, 15 - lvt_2_1_), new Object[]{"###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150405_ch), Character.valueOf('X'), new ItemStack(Items.field_151100_aR, 1, lvt_2_1_)});
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150399_cn, 8, 15 - lvt_2_1_), new Object[]{"###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150359_w), Character.valueOf('X'), new ItemStack(Items.field_151100_aR, 1, lvt_2_1_)});
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150397_co, 16, lvt_2_1_), new Object[]{"###", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150399_cn, 1, lvt_2_1_)});
      }
      ...
      for(int lvt_2_2_ = 0; lvt_2_2_ < 16; ++lvt_2_2_) {
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150404_cg, 3, lvt_2_2_), new Object[]{"##", Character.valueOf('#'), new ItemStack(Blocks.field_150325_L, 1, lvt_2_2_)});
      }
