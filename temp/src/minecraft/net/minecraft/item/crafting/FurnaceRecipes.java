...
public class FurnaceRecipes {
   ...
   public ItemStack func_151395_a(ItemStack p_151395_1_) {
      for(Entry<ItemStack, ItemStack> lvt_3_1_ : this.field_77604_b.entrySet()) {
         if(this.func_151397_a(p_151395_1_, (ItemStack)lvt_3_1_.getKey())) {
   ...
   public float func_151398_b(ItemStack p_151398_1_) {
      for(Entry<ItemStack, Float> lvt_3_1_ : this.field_77605_c.entrySet()) {
         if(this.func_151397_a(p_151398_1_, (ItemStack)lvt_3_1_.getKey())) {
