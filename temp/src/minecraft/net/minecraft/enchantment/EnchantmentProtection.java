...
public class EnchantmentProtection extends Enchantment {
   ...
   public int func_77318_a(int p_77318_1_, DamageSource p_77318_2_) {
      if(p_77318_2_.func_76357_e()) {
         ...
         return this.field_77356_a == 0?MathHelper.func_76141_d(lvt_3_1_ * 0.75F):(this.field_77356_a == 1 && p_77318_2_.func_76347_k()?MathHelper.func_76141_d(lvt_3_1_ * 1.25F):(this.field_77356_a == 2 && p_77318_2_ == DamageSource.field_76379_h?MathHelper.func_76141_d(lvt_3_1_ * 2.5F):(this.field_77356_a == 3 && p_77318_2_.func_94541_c()?MathHelper.func_76141_d(lvt_3_1_ * 1.5F):(this.field_77356_a == 4 && p_77318_2_.func_76352_a()?MathHelper.func_76141_d(lvt_3_1_ * 1.5F):0))));
      }
   }
   ...
   public boolean func_77326_a(Enchantment p_77326_1_) {
      if(p_77326_1_ instanceof EnchantmentProtection) {
         ...
         return lvt_2_1_.field_77356_a == this.field_77356_a?false:this.field_77356_a == 2 || lvt_2_1_.field_77356_a == 2;
      } else {
