...
public class ChunkProviderClient implements IChunkProvider {
   ...
   public boolean func_73156_b() {
      ...
      for(Chunk lvt_4_1_ : this.field_73237_c) {
         lvt_4_1_.func_150804_b(System.currentTimeMillis() - lvt_1_1_ > 5L);
      }

      if(System.currentTimeMillis() - lvt_1_1_ > 100L) {
         field_147436_a.info("Warning: Clientside chunk ticking took {} ms", new Object[]{Long.valueOf(System.currentTimeMillis() - lvt_1_1_)});
      }
