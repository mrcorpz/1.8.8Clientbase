...
public class ModelRenderer {
   ...
   public ModelRenderer func_78786_a(String p_78786_1_, float p_78786_2_, float p_78786_3_, float p_78786_4_, int p_78786_5_, int p_78786_6_, int p_78786_7_) {
      ...
      TextureOffset lvt_8_1_ = this.field_78810_s.func_78084_a(p_78786_1_);
      this.func_78784_a(lvt_8_1_.field_78783_a, lvt_8_1_.field_78782_b);
         ...
         if(this.field_78806_j) {
            ...
            if(this.field_78795_f == 0.0F && this.field_78796_g == 0.0F && this.field_78808_h == 0.0F) {
               if(this.field_78800_c == 0.0F && this.field_78797_d == 0.0F && this.field_78798_e == 0.0F) {
                  ...
                  if(this.field_78805_m != null) {
                     for(int lvt_2_3_ = 0; lvt_2_3_ < this.field_78805_m.size(); ++lvt_2_3_) {
                        ((ModelRenderer)this.field_78805_m.get(lvt_2_3_)).func_78785_a(p_78785_1_);
                     }
                  }
               } else {
                  ...
                  GlStateManager.func_179148_o(this.field_78811_r);
                  if(this.field_78805_m != null) {
                     for(int lvt_2_2_ = 0; lvt_2_2_ < this.field_78805_m.size(); ++lvt_2_2_) {
                        ((ModelRenderer)this.field_78805_m.get(lvt_2_2_)).func_78785_a(p_78785_1_);
                     }
                  }
               ...
               GlStateManager.func_179148_o(this.field_78811_r);
               if(this.field_78805_m != null) {
                  for(int lvt_2_1_ = 0; lvt_2_1_ < this.field_78805_m.size(); ++lvt_2_1_) {
                     ((ModelRenderer)this.field_78805_m.get(lvt_2_1_)).func_78785_a(p_78785_1_);
                  }
               }
   ...
   private void func_78788_d(float p_78788_1_) {
      ...
      WorldRenderer lvt_2_1_ = Tessellator.func_178181_a().func_178180_c();

      for(int lvt_3_1_ = 0; lvt_3_1_ < this.field_78804_l.size(); ++lvt_3_1_) {
         ((ModelBox)this.field_78804_l.get(lvt_3_1_)).func_178780_a(lvt_2_1_, p_78788_1_);
      }
