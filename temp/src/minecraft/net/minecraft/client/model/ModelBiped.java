...
public class ModelBiped extends ModelBase {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      if(this.field_78095_p > -9990.0F) {
         float lvt_8_1_ = this.field_78095_p;
         this.field_78115_e.field_78796_g = MathHelper.func_76126_a(MathHelper.func_76129_c(lvt_8_1_) * 3.1415927F * 2.0F) * 0.2F;
         ...
         lvt_8_1_ = 1.0F - this.field_78095_p;
         lvt_8_1_ = lvt_8_1_ * lvt_8_1_;
         lvt_8_1_ = lvt_8_1_ * lvt_8_1_;
         lvt_8_1_ = 1.0F - lvt_8_1_;
         float lvt_9_1_ = MathHelper.func_76126_a(lvt_8_1_ * 3.1415927F);
         float lvt_10_1_ = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F) * -(this.field_78116_c.field_78795_f - 0.7F) * 0.75F;
         this.field_178723_h.field_78795_f = (float)((double)this.field_178723_h.field_78795_f - ((double)lvt_9_1_ * 1.2D + (double)lvt_10_1_));
      ...
      if(this.field_78118_o) {
         ...
         this.field_178723_h.field_78795_f -= lvt_8_2_ * 1.2F - lvt_9_2_ * 0.4F;
         this.field_178724_i.field_78795_f -= lvt_8_2_ * 1.2F - lvt_9_2_ * 0.4F;
         this.field_178723_h.field_78808_h += MathHelper.func_76134_b(p_78087_3_ * 0.09F) * 0.05F + 0.05F;
         this.field_178724_i.field_78808_h -= MathHelper.func_76134_b(p_78087_3_ * 0.09F) * 0.05F + 0.05F;
         this.field_178723_h.field_78795_f += MathHelper.func_76126_a(p_78087_3_ * 0.067F) * 0.05F;
         this.field_178724_i.field_78795_f -= MathHelper.func_76126_a(p_78087_3_ * 0.067F) * 0.05F;
