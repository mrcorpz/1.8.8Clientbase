...
public class GuiChat extends GuiScreen {
   ...
   public void func_146404_p_() {
      if(this.field_146417_i) {
         ...
         String lvt_3_1_ = this.field_146415_a.func_146179_b().substring(0, this.field_146415_a.func_146198_h());
         this.func_146405_a(lvt_3_1_, lvt_2_1_);
      ...
      if(this.field_146412_t.size() > 1) {
         ...
         for(String lvt_3_2_ : this.field_146412_t) {
