...
public class GuiVideoSettings extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      if(!OpenGlHelper.field_176083_O) {
         GameSettings.Options[] lvt_1_1_ = new GameSettings.Options[field_146502_i.length - 1];
         int lvt_2_1_ = 0;

         for(GameSettings.Options lvt_6_1_ : field_146502_i) {
         ...
         this.field_146501_h = new GuiOptionsRowList(this.field_146297_k, this.field_146294_l, this.field_146295_m, 32, this.field_146295_m - 32, 25, lvt_1_1_);
      } else {
   ...
   protected void func_73864_a(int p_73864_1_, int p_73864_2_, int p_73864_3_) throws IOException {
      int lvt_4_1_ = this.field_146499_g.field_74335_Z;
      super.func_73864_a(p_73864_1_, p_73864_2_, p_73864_3_);
      this.field_146501_h.func_148179_a(p_73864_1_, p_73864_2_, p_73864_3_);
      if(this.field_146499_g.field_74335_Z != lvt_4_1_) {
         ScaledResolution lvt_5_1_ = new ScaledResolution(this.field_146297_k);
         int lvt_6_1_ = lvt_5_1_.func_78326_a();
         int lvt_7_1_ = lvt_5_1_.func_78328_b();
         this.func_146280_a(this.field_146297_k, lvt_6_1_, lvt_7_1_);
      }
