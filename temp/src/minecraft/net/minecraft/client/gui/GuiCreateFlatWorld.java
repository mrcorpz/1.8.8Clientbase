...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   class Details extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         String lvt_13_1_;
         if(p_180791_1_ == 0) {
            lvt_13_1_ = I18n.func_135052_a("createWorld.customize.flat.layer.top", new Object[]{Integer.valueOf(lvt_7_1_.func_82657_a())});
         } else if(p_180791_1_ == GuiCreateFlatWorld.this.field_146387_g.func_82650_c().size() - 1) {
            lvt_13_1_ = I18n.func_135052_a("createWorld.customize.flat.layer.bottom", new Object[]{Integer.valueOf(lvt_7_1_.func_82657_a())});
         } else {
            lvt_13_1_ = I18n.func_135052_a("createWorld.customize.flat.layer", new Object[]{Integer.valueOf(lvt_7_1_.func_82657_a())});
         }

         GuiCreateFlatWorld.this.field_146289_q.func_78276_b(lvt_13_1_, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.field_146289_q.func_78256_a(lvt_13_1_), p_180791_3_ + 3, 16777215);
      }
