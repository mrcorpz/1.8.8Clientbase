   ...
   public void func_73866_w_() {
      ...
      for(GameSettings.Options lvt_5_1_ : field_152312_a) {
         if(lvt_5_1_.func_74380_a()) {
            ...
            this.field_146292_n.add(new GuiOptionButton(lvt_5_1_.func_74381_c(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, this.field_146295_m / 6 + 24 * (lvt_1_1_ >> 1), lvt_5_1_, this.field_152318_h.func_74297_c(lvt_5_1_)));
         }
      ...
      GuiButton lvt_2_3_ = new GuiButton(201, this.field_146294_l / 2 + 5, this.field_146295_m / 6 + 168, 150, 20, I18n.func_135052_a("options.stream.ingestSelection", new Object[0]));
