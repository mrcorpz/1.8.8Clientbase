...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
   ...
   protected String func_146614_d(int p_146614_1_) {
      ...
      if(StringUtils.isEmpty(lvt_2_1_)) {
         lvt_2_1_ = I18n.func_135052_a("selectWorld.world", new Object[0]) + " " + (p_146614_1_ + 1);
      }
   ...
   public static GuiYesNo func_152129_a(GuiYesNoCallback p_152129_0_, String p_152129_1_, int p_152129_2_) {
      String lvt_3_1_ = I18n.func_135052_a("selectWorld.deleteQuestion", new Object[0]);
      String lvt_4_1_ = "\'" + p_152129_1_ + "\' " + I18n.func_135052_a("selectWorld.deleteWarning", new Object[0]);
      String lvt_5_1_ = I18n.func_135052_a("selectWorld.deleteButton", new Object[0]);
      String lvt_6_1_ = I18n.func_135052_a("gui.cancel", new Object[0]);
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         if(lvt_7_1_.func_75785_d()) {
            ...
            if(lvt_7_1_.func_75789_g()) {
               lvt_10_1_ = EnumChatFormatting.DARK_RED + I18n.func_135052_a("gameMode.hardcore", new Object[0]) + EnumChatFormatting.RESET;
            }

            if(lvt_7_1_.func_75783_h()) {
               lvt_10_1_ = lvt_10_1_ + ", " + I18n.func_135052_a("selectWorld.cheats", new Object[0]);
            }
         }
