...
public class ResourcePackListEntryDefault extends ResourcePackListEntry {
   ...
   public ResourcePackListEntryDefault(GuiScreenResourcePacks p_i45052_1_) {
      ...
      try {
         lvt_2_1_ = new DynamicTexture(this.field_148320_d.func_110586_a());
      } catch (IOException var4) {
         lvt_2_1_ = TextureUtil.field_111001_a;
      }

      this.field_148321_e = this.field_148317_a.func_110434_K().func_110578_a("texturepackicon", lvt_2_1_);
   }
