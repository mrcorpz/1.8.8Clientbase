...
public class ItemModelMesher {
   ...
   public IBakedModel func_178089_a(ItemStack p_178089_1_) {
      Item lvt_2_1_ = p_178089_1_.func_77973_b();
      IBakedModel lvt_3_1_ = this.func_178088_b(lvt_2_1_, this.func_178084_b(p_178089_1_));
      if(lvt_3_1_ == null) {
         ItemMeshDefinition lvt_4_1_ = (ItemMeshDefinition)this.field_178092_c.get(lvt_2_1_);
         if(lvt_4_1_ != null) {
            lvt_3_1_ = this.field_178090_d.func_174953_a(lvt_4_1_.func_178113_a(p_178089_1_));
         }
      }

      if(lvt_3_1_ == null) {
         lvt_3_1_ = this.field_178090_d.func_174951_a();
      }
   ...
   public void func_178085_b() {
      ...
      for(Entry<Integer, ModelResourceLocation> lvt_2_1_ : this.field_178093_a.entrySet()) {
         this.field_178091_b.put(lvt_2_1_.getKey(), this.field_178090_d.func_174953_a((ModelResourceLocation)lvt_2_1_.getValue()));
      }
