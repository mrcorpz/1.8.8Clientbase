...
public class GlStateManager {
   ...
   public static void func_179149_a(GlStateManager.TexGen p_179149_0_, int p_179149_1_) {
      GlStateManager.TexGenCoord lvt_2_1_ = func_179125_c(p_179149_0_);
      if(p_179149_1_ != lvt_2_1_.field_179066_c) {
         lvt_2_1_.field_179066_c = p_179149_1_;
         GL11.glTexGeni(lvt_2_1_.field_179065_b, 9472, p_179149_1_);
      }
   ...
   public static void func_179150_h(int p_179150_0_) {
      ...
      for(GlStateManager.TextureState lvt_4_1_ : field_179174_p) {
         if(lvt_4_1_.field_179059_b == p_179150_0_) {
            lvt_4_1_.field_179059_b = -1;
         }
      }
   ...
   static {
      for(int lvt_0_1_ = 0; lvt_0_1_ < 8; ++lvt_0_1_) {
         field_179159_c[lvt_0_1_] = new GlStateManager.BooleanState(16384 + lvt_0_1_);
      }

      for(int lvt_0_2_ = 0; lvt_0_2_ < 8; ++lvt_0_2_) {
         field_179174_p[lvt_0_2_] = new GlStateManager.TextureState();
      }
