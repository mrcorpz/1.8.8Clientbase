...
public class OpenGlHelper {
   ...
   public static void func_77474_a() {
      ...
      field_153215_z = lvt_0_1_.GL_ARB_multitexture && !lvt_0_1_.OpenGL13;
      field_176088_V = lvt_0_1_.GL_ARB_texture_env_combine && !lvt_0_1_.OpenGL13;
      if(field_153215_z) {
      ...
      field_153211_u = lvt_0_1_.GL_EXT_blend_func_separate && !lvt_0_1_.OpenGL14;
      field_148828_i = lvt_0_1_.OpenGL14 || lvt_0_1_.GL_EXT_blend_func_separate;
      field_148823_f = field_148828_i && (lvt_0_1_.GL_ARB_framebuffer_object || lvt_0_1_.GL_EXT_framebuffer_object || lvt_0_1_.OpenGL30);
      if(field_148823_f) {
         ...
         field_153196_B = field_153196_B + "OpenGL 1.4 is " + (lvt_0_1_.OpenGL14?"":"not ") + "supported, ";
         field_153196_B = field_153196_B + "EXT_blend_func_separate is " + (lvt_0_1_.GL_EXT_blend_func_separate?"":"not ") + "supported, ";
         field_153196_B = field_153196_B + "OpenGL 3.0 is " + (lvt_0_1_.OpenGL30?"":"not ") + "supported, ";
         field_153196_B = field_153196_B + "ARB_framebuffer_object is " + (lvt_0_1_.GL_ARB_framebuffer_object?"":"not ") + "supported, and ";
         field_153196_B = field_153196_B + "EXT_framebuffer_object is " + (lvt_0_1_.GL_EXT_framebuffer_object?"":"not ") + "supported.\n";
      }

      field_148827_a = lvt_0_1_.OpenGL21;
      field_153213_x = field_148827_a || lvt_0_1_.GL_ARB_vertex_shader && lvt_0_1_.GL_ARB_fragment_shader && lvt_0_1_.GL_ARB_shader_objects;
      ...
      if(field_153213_x) {
         ...
         field_153196_B = field_153196_B + "OpenGL 2.1 is " + (lvt_0_1_.OpenGL21?"":"not ") + "supported, ";
         field_153196_B = field_153196_B + "ARB_shader_objects is " + (lvt_0_1_.GL_ARB_shader_objects?"":"not ") + "supported, ";
         field_153196_B = field_153196_B + "ARB_vertex_shader is " + (lvt_0_1_.GL_ARB_vertex_shader?"":"not ") + "supported, and ";
         field_153196_B = field_153196_B + "ARB_fragment_shader is " + (lvt_0_1_.GL_ARB_fragment_shader?"":"not ") + "supported.\n";
      }

      field_148824_g = field_148823_f && field_153213_x;
      String lvt_1_1_ = GL11.glGetString(7936).toLowerCase();
      field_153197_d = lvt_1_1_.contains("nvidia");
      field_176090_Y = !lvt_0_1_.OpenGL15 && lvt_0_1_.GL_ARB_vertex_buffer_object;
      field_176083_O = lvt_0_1_.OpenGL15 || field_176090_Y;
      ...
      field_181063_b = lvt_1_1_.contains("ati");
      if(field_181063_b) {
         if(field_176083_O) {
            field_181062_Q = true;
         } else {
      ...
      try {
         ...
         field_183030_aa = String.format("%dx %s", new Object[]{Integer.valueOf(lvt_2_1_.length), lvt_2_1_[0]}).replaceAll("\\s+", " ");
