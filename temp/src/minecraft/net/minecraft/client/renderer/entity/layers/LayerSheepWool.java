...
public class LayerSheepWool implements LayerRenderer<EntitySheep> {
   ...
   public void func_177141_a(EntitySheep p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
      if(!p_177141_1_.func_70892_o() && !p_177141_1_.func_82150_aj()) {
         ...
         if(p_177141_1_.func_145818_k_() && "jeb_".equals(p_177141_1_.func_95999_t())) {
            int lvt_9_1_ = 25;
            int lvt_10_1_ = p_177141_1_.field_70173_aa / 25 + p_177141_1_.func_145782_y();
            int lvt_11_1_ = EnumDyeColor.values().length;
            int lvt_12_1_ = lvt_10_1_ % lvt_11_1_;
            int lvt_13_1_ = (lvt_10_1_ + 1) % lvt_11_1_;
            float lvt_14_1_ = ((float)(p_177141_1_.field_70173_aa % 25) + p_177141_4_) / 25.0F;
            float[] lvt_15_1_ = EntitySheep.func_175513_a(EnumDyeColor.func_176764_b(lvt_12_1_));
            float[] lvt_16_1_ = EntitySheep.func_175513_a(EnumDyeColor.func_176764_b(lvt_13_1_));
            GlStateManager.func_179124_c(lvt_15_1_[0] * (1.0F - lvt_14_1_) + lvt_16_1_[0] * lvt_14_1_, lvt_15_1_[1] * (1.0F - lvt_14_1_) + lvt_16_1_[1] * lvt_14_1_, lvt_15_1_[2] * (1.0F - lvt_14_1_) + lvt_16_1_[2] * lvt_14_1_);
         } else {
            float[] lvt_9_2_ = EntitySheep.func_175513_a(p_177141_1_.func_175509_cj());
            GlStateManager.func_179124_c(lvt_9_2_[0], lvt_9_2_[1], lvt_9_2_[2]);
         }
   ...
   public void func_177141_a(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
      this.func_177141_a((EntitySheep)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
   }
}
