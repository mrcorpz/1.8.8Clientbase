...
public class RenderManager {
   ...
   public <T extends Entity> Render<T> func_78715_a(Class<? extends Entity> p_78715_1_) {
      ...
      if(lvt_2_1_ == null && p_78715_1_ != Entity.class) {
         lvt_2_1_ = this.<Entity>func_78715_a(p_78715_1_.getSuperclass());
   ...
   public void func_180597_a(World p_180597_1_, FontRenderer p_180597_2_, Entity p_180597_3_, Entity p_180597_4_, GameSettings p_180597_5_, float p_180597_6_) {
      ...
      if(p_180597_3_ instanceof EntityLivingBase && ((EntityLivingBase)p_180597_3_).func_70608_bn()) {
         IBlockState lvt_7_1_ = p_180597_1_.func_180495_p(new BlockPos(p_180597_3_));
         Block lvt_8_1_ = lvt_7_1_.func_177230_c();
         if(lvt_8_1_ == Blocks.field_150324_C) {
            int lvt_9_1_ = ((EnumFacing)lvt_7_1_.func_177229_b(BlockBed.field_176387_N)).func_176736_b();
            this.field_78735_i = (float)(lvt_9_1_ * 90 + 180);
   ...
   public boolean func_178635_a(Entity p_178635_1_, ICamera p_178635_2_, double p_178635_3_, double p_178635_5_, double p_178635_7_) {
      Render<Entity> lvt_9_1_ = this.<Entity>func_78713_a(p_178635_1_);
      return lvt_9_1_ != null && lvt_9_1_.func_177071_a(p_178635_1_, p_178635_2_, p_178635_3_, p_178635_5_, p_178635_7_);
   }
   ...
   public boolean func_147936_a(Entity p_147936_1_, float p_147936_2_, boolean p_147936_3_) {
      ...
      double lvt_4_1_ = p_147936_1_.field_70142_S + (p_147936_1_.field_70165_t - p_147936_1_.field_70142_S) * (double)p_147936_2_;
      double lvt_6_1_ = p_147936_1_.field_70137_T + (p_147936_1_.field_70163_u - p_147936_1_.field_70137_T) * (double)p_147936_2_;
      double lvt_8_1_ = p_147936_1_.field_70136_U + (p_147936_1_.field_70161_v - p_147936_1_.field_70136_U) * (double)p_147936_2_;
      float lvt_10_1_ = p_147936_1_.field_70126_B + (p_147936_1_.field_70177_z - p_147936_1_.field_70126_B) * p_147936_2_;
      int lvt_11_1_ = p_147936_1_.func_70070_b(p_147936_2_);
      ...
      return this.func_147939_a(p_147936_1_, lvt_4_1_ - this.field_78725_b, lvt_6_1_ - this.field_78726_c, lvt_8_1_ - this.field_78723_d, lvt_10_1_, p_147936_2_, p_147936_3_);
   }

   public void func_178630_b(Entity p_178630_1_, float p_178630_2_) {
      double lvt_3_1_ = p_178630_1_.field_70142_S + (p_178630_1_.field_70165_t - p_178630_1_.field_70142_S) * (double)p_178630_2_;
      double lvt_5_1_ = p_178630_1_.field_70137_T + (p_178630_1_.field_70163_u - p_178630_1_.field_70137_T) * (double)p_178630_2_;
      double lvt_7_1_ = p_178630_1_.field_70136_U + (p_178630_1_.field_70161_v - p_178630_1_.field_70136_U) * (double)p_178630_2_;
      Render<Entity> lvt_9_1_ = this.<Entity>func_78713_a(p_178630_1_);
      if(lvt_9_1_ != null && this.field_78724_e != null) {
         int lvt_10_1_ = p_178630_1_.func_70070_b(p_178630_2_);
         int lvt_11_1_ = lvt_10_1_ % 65536;
         int lvt_12_1_ = lvt_10_1_ / 65536;
         OpenGlHelper.func_77475_a(OpenGlHelper.field_77476_b, (float)lvt_11_1_ / 1.0F, (float)lvt_12_1_ / 1.0F);
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
         lvt_9_1_.func_177067_a(p_178630_1_, lvt_3_1_ - this.field_78725_b, lvt_5_1_ - this.field_78726_c, lvt_7_1_ - this.field_78723_d);
      }
   ...
   public boolean func_147939_a(Entity p_147939_1_, double p_147939_2_, double p_147939_4_, double p_147939_6_, float p_147939_8_, float p_147939_9_, boolean p_147939_10_) {
      ...
      try {
         lvt_11_1_ = this.<Entity>func_78713_a(p_147939_1_);
         if(lvt_11_1_ != null && this.field_78724_e != null) {
            try {
               if(lvt_11_1_ instanceof RendererLivingEntity) {
                  ((RendererLivingEntity)lvt_11_1_).func_177086_a(this.field_178639_r);
               }

               lvt_11_1_.func_76986_a(p_147939_1_, p_147939_2_, p_147939_4_, p_147939_6_, p_147939_8_, p_147939_9_);
            ...
            try {
               if(!this.field_178639_r) {
                  lvt_11_1_.func_76979_b(p_147939_1_, p_147939_2_, p_147939_4_, p_147939_6_, p_147939_8_, p_147939_9_);
               }
         ...
         CrashReport lvt_13_1_ = CrashReport.func_85055_a(var19, "Rendering entity in world");
         CrashReportCategory lvt_14_1_ = lvt_13_1_.func_85058_a("Entity being rendered");
         p_147939_1_.func_85029_a(lvt_14_1_);
         CrashReportCategory lvt_15_1_ = lvt_13_1_.func_85058_a("Renderer details");
         lvt_15_1_.func_71507_a("Assigned renderer", lvt_11_1_);
         lvt_15_1_.func_71507_a("Location", CrashReportCategory.func_85074_a(p_147939_2_, p_147939_4_, p_147939_6_));
         lvt_15_1_.func_71507_a("Rotation", Float.valueOf(p_147939_8_));
         lvt_15_1_.func_71507_a("Delta", Float.valueOf(p_147939_9_));
   ...
   private void func_85094_b(Entity p_85094_1_, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_) {
      ...
      float lvt_10_1_ = p_85094_1_.field_70130_N / 2.0F;
      AxisAlignedBB lvt_11_1_ = p_85094_1_.func_174813_aQ();
      AxisAlignedBB lvt_12_1_ = new AxisAlignedBB(lvt_11_1_.field_72340_a - p_85094_1_.field_70165_t + p_85094_2_, lvt_11_1_.field_72338_b - p_85094_1_.field_70163_u + p_85094_4_, lvt_11_1_.field_72339_c - p_85094_1_.field_70161_v + p_85094_6_, lvt_11_1_.field_72336_d - p_85094_1_.field_70165_t + p_85094_2_, lvt_11_1_.field_72337_e - p_85094_1_.field_70163_u + p_85094_4_, lvt_11_1_.field_72334_f - p_85094_1_.field_70161_v + p_85094_6_);
      RenderGlobal.func_181563_a(lvt_12_1_, 255, 255, 255, 255);
      if(p_85094_1_ instanceof EntityLivingBase) {
         float lvt_13_1_ = 0.01F;
         RenderGlobal.func_181563_a(new AxisAlignedBB(p_85094_2_ - (double)lvt_10_1_, p_85094_4_ + (double)p_85094_1_.func_70047_e() - 0.009999999776482582D, p_85094_6_ - (double)lvt_10_1_, p_85094_2_ + (double)lvt_10_1_, p_85094_4_ + (double)p_85094_1_.func_70047_e() + 0.009999999776482582D, p_85094_6_ + (double)lvt_10_1_), 255, 0, 0, 255);
      }

      Tessellator lvt_13_2_ = Tessellator.func_178181_a();
      WorldRenderer lvt_14_1_ = lvt_13_2_.func_178180_c();
      Vec3 lvt_15_1_ = p_85094_1_.func_70676_i(p_85094_9_);
      lvt_14_1_.func_181668_a(3, DefaultVertexFormats.field_181706_f);
      lvt_14_1_.func_181662_b(p_85094_2_, p_85094_4_ + (double)p_85094_1_.func_70047_e(), p_85094_6_).func_181669_b(0, 0, 255, 255).func_181675_d();
      lvt_14_1_.func_181662_b(p_85094_2_ + lvt_15_1_.field_72450_a * 2.0D, p_85094_4_ + (double)p_85094_1_.func_70047_e() + lvt_15_1_.field_72448_b * 2.0D, p_85094_6_ + lvt_15_1_.field_72449_c * 2.0D).func_181669_b(0, 0, 255, 255).func_181675_d();
      lvt_13_2_.func_78381_a();
   ...
   public double func_78714_a(double p_78714_1_, double p_78714_3_, double p_78714_5_) {
      double lvt_7_1_ = p_78714_1_ - this.field_78730_l;
      double lvt_9_1_ = p_78714_3_ - this.field_78731_m;
      double lvt_11_1_ = p_78714_5_ - this.field_78728_n;
