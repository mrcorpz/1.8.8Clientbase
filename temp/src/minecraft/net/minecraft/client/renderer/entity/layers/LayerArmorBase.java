...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
   ...
   private void func_177182_a(EntityLivingBase p_177182_1_, float p_177182_2_, float p_177182_3_, float p_177182_4_, float p_177182_5_, float p_177182_6_, float p_177182_7_, float p_177182_8_, int p_177182_9_) {
      ItemStack lvt_10_1_ = this.func_177176_a(p_177182_1_, p_177182_9_);
      if(lvt_10_1_ != null && lvt_10_1_.func_77973_b() instanceof ItemArmor) {
         ItemArmor lvt_11_1_ = (ItemArmor)lvt_10_1_.func_77973_b();
         T lvt_12_1_ = this.func_177175_a(p_177182_9_);
         lvt_12_1_.func_178686_a(this.field_177190_a.func_177087_b());
         lvt_12_1_.func_78086_a(p_177182_1_, p_177182_2_, p_177182_3_, p_177182_4_);
         this.func_177179_a(lvt_12_1_, p_177182_9_);
         boolean lvt_13_1_ = this.func_177180_b(p_177182_9_);
         this.field_177190_a.func_110776_a(this.func_177181_a(lvt_11_1_, lvt_13_1_));
         switch(lvt_11_1_.func_82812_d()) {
         case LEATHER:
            int lvt_14_1_ = lvt_11_1_.func_82814_b(lvt_10_1_);
            ...
            GlStateManager.func_179131_c(this.field_177184_f * lvt_15_1_, this.field_177185_g * lvt_16_1_, this.field_177192_h * lvt_17_1_, this.field_177187_e);
            lvt_12_1_.func_78088_a(p_177182_1_, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
            this.field_177190_a.func_110776_a(this.func_177178_a(lvt_11_1_, lvt_13_1_, "overlay"));
         case CHAIN:
         case IRON:
         case GOLD:
         case DIAMOND:
            ...
            lvt_12_1_.func_78088_a(p_177182_1_, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
         default:
            if(!this.field_177193_i && lvt_10_1_.func_77948_v()) {
               this.func_177183_a(p_177182_1_, lvt_12_1_, p_177182_2_, p_177182_3_, p_177182_4_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
            }
   ...
   private void func_177183_a(EntityLivingBase p_177183_1_, T p_177183_2_, float p_177183_3_, float p_177183_4_, float p_177183_5_, float p_177183_6_, float p_177183_7_, float p_177183_8_, float p_177183_9_) {
      float lvt_10_1_ = (float)p_177183_1_.field_70173_aa + p_177183_5_;
      ...
      for(int lvt_12_1_ = 0; lvt_12_1_ < 2; ++lvt_12_1_) {
         ...
         GlStateManager.func_179131_c(0.5F * lvt_13_1_, 0.25F * lvt_13_1_, 0.8F * lvt_13_1_, 1.0F);
         GlStateManager.func_179128_n(5890);
         GlStateManager.func_179096_D();
         float lvt_14_1_ = 0.33333334F;
         GlStateManager.func_179152_a(lvt_14_1_, lvt_14_1_, lvt_14_1_);
         GlStateManager.func_179114_b(30.0F - (float)lvt_12_1_ * 60.0F, 0.0F, 0.0F, 1.0F);
         GlStateManager.func_179109_b(0.0F, lvt_10_1_ * (0.001F + (float)lvt_12_1_ * 0.003F) * 20.0F, 0.0F);
   ...
   private ResourceLocation func_177178_a(ItemArmor p_177178_1_, boolean p_177178_2_, String p_177178_3_) {
      String lvt_4_1_ = String.format("textures/models/armor/%s_layer_%d%s.png", new Object[]{p_177178_1_.func_82812_d().func_179242_c(), Integer.valueOf(p_177178_2_?2:1), p_177178_3_ == null?"":String.format("_%s", new Object[]{p_177178_3_})});
      ResourceLocation lvt_5_1_ = (ResourceLocation)field_177191_j.get(lvt_4_1_);
      if(lvt_5_1_ == null) {
         lvt_5_1_ = new ResourceLocation(lvt_4_1_);
         field_177191_j.put(lvt_4_1_, lvt_5_1_);
      }
