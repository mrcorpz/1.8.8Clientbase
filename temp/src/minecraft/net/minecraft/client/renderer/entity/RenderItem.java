...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_) {
      ...
      lvt_5_1_.func_181668_a(7, DefaultVertexFormats.field_176599_b);

      for(EnumFacing lvt_9_1_ : EnumFacing.values()) {
         this.func_175032_a(lvt_5_1_, p_175045_1_.func_177551_a(lvt_9_1_), p_175045_2_, p_175045_3_);
      }

      this.func_175032_a(lvt_5_1_, p_175045_1_.func_177550_a(), p_175045_2_, p_175045_3_);
   ...
   private void func_180451_a(IBakedModel p_180451_1_) {
      ...
      float lvt_2_1_ = (float)(Minecraft.func_71386_F() % 3000L) / 3000.0F / 8.0F;
      GlStateManager.func_179109_b(lvt_2_1_, 0.0F, 0.0F);
      GlStateManager.func_179114_b(-50.0F, 0.0F, 0.0F, 1.0F);
      this.func_175035_a(p_180451_1_, -8372020);
      GlStateManager.func_179121_F();
      GlStateManager.func_179094_E();
      GlStateManager.func_179152_a(8.0F, 8.0F, 8.0F);
      float lvt_3_1_ = (float)(Minecraft.func_71386_F() % 4873L) / 4873.0F / 8.0F;
      GlStateManager.func_179109_b(-lvt_3_1_, 0.0F, 0.0F);
   ...
   private void func_175038_a(WorldRenderer p_175038_1_, BakedQuad p_175038_2_) {
      Vec3i lvt_3_1_ = p_175038_2_.func_178210_d().func_176730_m();
      p_175038_1_.func_178975_e((float)lvt_3_1_.func_177958_n(), (float)lvt_3_1_.func_177956_o(), (float)lvt_3_1_.func_177952_p());
   }
   ...
   private void func_175032_a(WorldRenderer p_175032_1_, List<BakedQuad> p_175032_2_, int p_175032_3_, ItemStack p_175032_4_) {
      boolean lvt_5_1_ = p_175032_3_ == -1 && p_175032_4_ != null;
      int lvt_6_1_ = 0;

      for(int lvt_7_1_ = p_175032_2_.size(); lvt_6_1_ < lvt_7_1_; ++lvt_6_1_) {
         BakedQuad lvt_8_1_ = (BakedQuad)p_175032_2_.get(lvt_6_1_);
         int lvt_9_1_ = p_175032_3_;
         if(lvt_5_1_ && lvt_8_1_.func_178212_b()) {
            lvt_9_1_ = p_175032_4_.func_77973_b().func_82790_a(p_175032_4_, lvt_8_1_.func_178211_c());
            if(EntityRenderer.field_78517_a) {
               lvt_9_1_ = TextureUtil.func_177054_c(lvt_9_1_);
            }

            lvt_9_1_ = lvt_9_1_ | -16777216;
         }

         this.func_175033_a(p_175032_1_, lvt_8_1_, lvt_9_1_);
      }

   }

   public boolean func_175050_a(ItemStack p_175050_1_) {
      IBakedModel lvt_2_1_ = this.field_175059_m.func_178089_a(p_175050_1_);
      return lvt_2_1_ == null?false:lvt_2_1_.func_177556_c();
   }

   private void func_175046_c(ItemStack p_175046_1_) {
      IBakedModel lvt_2_1_ = this.field_175059_m.func_178089_a(p_175046_1_);
      Item lvt_3_1_ = p_175046_1_.func_77973_b();
      if(lvt_3_1_ != null) {
         boolean lvt_4_1_ = lvt_2_1_.func_177556_c();
         if(!lvt_4_1_) {
   ...
   public void func_181564_a(ItemStack p_181564_1_, ItemCameraTransforms.TransformType p_181564_2_) {
      if(p_181564_1_ != null) {
         IBakedModel lvt_3_1_ = this.field_175059_m.func_178089_a(p_181564_1_);
         this.func_175040_a(p_181564_1_, lvt_3_1_, p_181564_2_);
      }
   }
   ...
   public void func_175049_a(ItemStack p_175049_1_, EntityLivingBase p_175049_2_, ItemCameraTransforms.TransformType p_175049_3_) {
      if(p_175049_1_ != null && p_175049_2_ != null) {
         IBakedModel lvt_4_1_ = this.field_175059_m.func_178089_a(p_175049_1_);
         if(p_175049_2_ instanceof EntityPlayer) {
            EntityPlayer lvt_5_1_ = (EntityPlayer)p_175049_2_;
            Item lvt_6_1_ = p_175049_1_.func_77973_b();
            ModelResourceLocation lvt_7_1_ = null;
            if(lvt_6_1_ == Items.field_151112_aM && lvt_5_1_.field_71104_cf != null) {
               lvt_7_1_ = new ModelResourceLocation("fishing_rod_cast", "inventory");
            } else if(lvt_6_1_ == Items.field_151031_f && lvt_5_1_.func_71011_bu() != null) {
               int lvt_8_1_ = p_175049_1_.func_77988_m() - lvt_5_1_.func_71052_bv();
               if(lvt_8_1_ >= 18) {
            ...
            if(lvt_7_1_ != null) {
               lvt_4_1_ = this.field_175059_m.func_178083_a().func_174953_a(lvt_7_1_);
            }
         }

         this.func_175040_a(p_175049_1_, lvt_4_1_, p_175049_3_);
      }
   }
   ...
   protected void func_175040_a(ItemStack p_175040_1_, IBakedModel p_175040_2_, ItemCameraTransforms.TransformType p_175040_3_) {
      ...
      GlStateManager.func_179094_E();
      ItemCameraTransforms lvt_4_1_ = p_175040_2_.func_177552_f();
      lvt_4_1_.func_181689_a(p_175040_3_);
      if(this.func_183005_a(lvt_4_1_.func_181688_b(p_175040_3_))) {
   ...
   public void func_175042_a(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_) {
      IBakedModel lvt_4_1_ = this.field_175059_m.func_178089_a(p_175042_1_);
      GlStateManager.func_179094_E();
      this.field_175057_n.func_110577_a(TextureMap.field_110575_b);
      this.field_175057_n.func_110581_b(TextureMap.field_110575_b).func_174936_b(false, false);
      GlStateManager.func_179091_B();
      ...
      GlStateManager.func_179112_b(770, 771);
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      this.func_180452_a(p_175042_2_, p_175042_3_, lvt_4_1_.func_177556_c());
      lvt_4_1_.func_177552_f().func_181689_a(ItemCameraTransforms.TransformType.GUI);
      this.func_180454_a(p_175042_1_, lvt_4_1_);
   ...
   public void func_180450_b(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_) {
      if(p_180450_1_ != null && p_180450_1_.func_77973_b() != null) {
         ...
         try {
            ...
            CrashReport lvt_5_1_ = CrashReport.func_85055_a(var7, "Rendering item");
            CrashReportCategory lvt_6_1_ = lvt_5_1_.func_85058_a("Item being rendered");
            lvt_6_1_.func_71500_a("Item Type", new Callable<String>() {
            ...
            lvt_6_1_.func_71500_a("Item Aux", new Callable<String>() {
               public String call() throws Exception {
            ...
            lvt_6_1_.func_71500_a("Item NBT", new Callable<String>() {
               public String call() throws Exception {
            ...
            lvt_6_1_.func_71500_a("Item Foil", new Callable<String>() {
               public String call() throws Exception {
   ...
   public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_) {
      if(p_180453_2_ != null) {
         if(p_180453_2_.field_77994_a != 1 || p_180453_5_ != null) {
            String lvt_6_1_ = p_180453_5_ == null?String.valueOf(p_180453_2_.field_77994_a):p_180453_5_;
            if(p_180453_5_ == null && p_180453_2_.field_77994_a < 1) {
               lvt_6_1_ = EnumChatFormatting.RED + String.valueOf(p_180453_2_.field_77994_a);
            }

            GlStateManager.func_179140_f();
            GlStateManager.func_179097_i();
            GlStateManager.func_179084_k();
            p_180453_1_.func_175063_a(lvt_6_1_, (float)(p_180453_3_ + 19 - 2 - p_180453_1_.func_78256_a(lvt_6_1_)), (float)(p_180453_4_ + 6 + 3), 16777215);
            GlStateManager.func_179145_e();
            GlStateManager.func_179126_j();
         }

         if(p_180453_2_.func_77951_h()) {
            int lvt_6_2_ = (int)Math.round(13.0D - (double)p_180453_2_.func_77952_i() * 13.0D / (double)p_180453_2_.func_77958_k());
            int lvt_7_1_ = (int)Math.round(255.0D - (double)p_180453_2_.func_77952_i() * 255.0D / (double)p_180453_2_.func_77958_k());
            GlStateManager.func_179140_f();
            GlStateManager.func_179097_i();
            ...
            this.func_181565_a(lvt_9_1_, p_180453_3_ + 2, p_180453_4_ + 13, 13, 2, 0, 0, 0, 255);
            this.func_181565_a(lvt_9_1_, p_180453_3_ + 2, p_180453_4_ + 13, 12, 1, (255 - lvt_7_1_) / 4, 64, 0, 255);
            this.func_181565_a(lvt_9_1_, p_180453_3_ + 2, p_180453_4_ + 13, lvt_6_2_, 1, 255 - lvt_7_1_, lvt_7_1_, 0, 255);
            GlStateManager.func_179147_l();
            GlStateManager.func_179141_d();
