...
public class ChunkRenderDispatcher {
   ...
   public ChunkRenderDispatcher() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < 2; ++lvt_1_1_) {
         ...
         Thread lvt_3_1_ = field_178521_b.newThread(lvt_2_1_);
         lvt_3_1_.start();
         this.field_178522_c.add(lvt_2_1_);
      }
   ...
   public boolean func_178507_a(RenderChunk p_178507_1_) {
      ...
      boolean var4;
      try {
         final ChunkCompileTaskGenerator lvt_2_1_ = p_178507_1_.func_178574_d();
         lvt_2_1_.func_178539_a(new Runnable() {
            public void run() {
               ChunkRenderDispatcher.this.field_178519_d.remove(lvt_2_1_);
            }
         });
         boolean lvt_3_1_ = this.field_178519_d.offer(lvt_2_1_);
         if(!lvt_3_1_) {
            lvt_2_1_.func_178542_e();
         }
   ...
   public boolean func_178505_b(RenderChunk p_178505_1_) {
      ...
      boolean var3;
      try {
         ChunkCompileTaskGenerator lvt_2_1_ = p_178505_1_.func_178574_d();

         try {
            this.field_178525_i.func_178474_a(lvt_2_1_);
   ...
   public void func_178514_b() {
      ...
      while(((List)lvt_1_1_).size() != 5) {
         try {
            lvt_1_1_.add(this.func_178515_c());
         } catch (InterruptedException var3) {
            ;
         }
      }

      this.field_178520_e.addAll(lvt_1_1_);
   }
   ...
   public boolean func_178509_c(RenderChunk p_178509_1_) {
      ...
      boolean var3;
      try {
         final ChunkCompileTaskGenerator lvt_2_1_ = p_178509_1_.func_178582_e();
         if(lvt_2_1_ == null) {
            var3 = true;
            return var3;
         }
         ...
         var3 = this.field_178519_d.offer(lvt_2_1_);
      } finally {
   ...
   public ListenableFuture<Object> func_178503_a(final EnumWorldBlockLayer p_178503_1_, final WorldRenderer p_178503_2_, final RenderChunk p_178503_3_, final CompiledChunk p_178503_4_) {
      if(Minecraft.func_71410_x().func_152345_ab()) {
         ...
         synchronized(this.field_178524_h) {
            this.field_178524_h.add(lvt_5_1_);
            return lvt_5_1_;
         }
      }
   }
   ...
   public void func_178513_e() {
      while(!this.field_178519_d.isEmpty()) {
         ChunkCompileTaskGenerator lvt_1_1_ = (ChunkCompileTaskGenerator)this.field_178519_d.poll();
         if(lvt_1_1_ != null) {
            lvt_1_1_.func_178542_e();
         }
      }
