   ...
   protected void func_152433_a() {
      this.field_110561_e = new Thread("Texture Downloader #" + field_147643_d.incrementAndGet()) {
         public void run() {
            ...
            try {
               lvt_1_1_ = (HttpURLConnection)(new URL(ThreadDownloadImageData.this.field_110562_b)).openConnection(Minecraft.func_71410_x().func_110437_J());
               ...
               if(lvt_1_1_.getResponseCode() / 100 == 2) {
                  ...
                  if(ThreadDownloadImageData.this.field_152434_e != null) {
                     FileUtils.copyInputStreamToFile(lvt_1_1_.getInputStream(), ThreadDownloadImageData.this.field_152434_e);
                     lvt_2_1_ = ImageIO.read(ThreadDownloadImageData.this.field_152434_e);
                  } else {
                     lvt_2_1_ = TextureUtil.func_177053_a(lvt_1_1_.getInputStream());
                  }

                  if(ThreadDownloadImageData.this.field_110563_c != null) {
                     lvt_2_1_ = ThreadDownloadImageData.this.field_110563_c.func_78432_a(lvt_2_1_);
                  }

                  ThreadDownloadImageData.this.func_147641_a(lvt_2_1_);
                  return;
               }
