...
public class EntityHugeExplodeFX extends EntityFX {
   ...
   public void func_70071_h_() {
      for(int lvt_1_1_ = 0; lvt_1_1_ < 6; ++lvt_1_1_) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, lvt_2_1_, lvt_4_1_, lvt_6_1_, (double)((float)this.field_70579_a / (float)this.field_70580_aq), 0.0D, 0.0D, new int[0]);
      }
