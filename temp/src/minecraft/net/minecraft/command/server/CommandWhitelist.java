   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if(p_71515_2_.length < 1) {
         ...
         if(p_71515_2_[0].equals("on")) {
            ...
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.whitelist.list", new Object[]{Integer.valueOf(lvt_3_1_.func_71203_ab().func_152598_l().length), Integer.valueOf(lvt_3_1_.func_71203_ab().func_72373_m().length)}));
            ...
            GameProfile lvt_4_2_ = lvt_3_1_.func_152358_ax().func_152655_a(p_71515_2_[1]);
            if(lvt_4_2_ == null) {
               throw new CommandException("commands.whitelist.add.failed", new Object[]{p_71515_2_[1]});
            }

            lvt_3_1_.func_71203_ab().func_152601_d(lvt_4_2_);
            ...
            GameProfile lvt_4_3_ = lvt_3_1_.func_71203_ab().func_152599_k().func_152706_a(p_71515_2_[1]);
            if(lvt_4_3_ == null) {
