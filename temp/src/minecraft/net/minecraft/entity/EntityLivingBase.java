...
public abstract class EntityLivingBase extends Entity {
   ...
   protected void func_180433_a(double p_180433_1_, boolean p_180433_3_, Block p_180433_4_, BlockPos p_180433_5_) {
      ...
      if(!this.field_70170_p.field_72995_K && this.field_70143_R > 3.0F && p_180433_3_) {
         ...
         if(lvt_7_1_.func_149688_o() != Material.field_151579_a) {
            ...
            ((WorldServer)this.field_70170_p).func_175739_a(EnumParticleTypes.BLOCK_DUST, this.field_70165_t, this.field_70163_u, this.field_70161_v, lvt_11_1_, 0.0D, 0.0D, 0.0D, 0.15000000596046448D, new int[]{Block.func_176210_f(lvt_6_1_)});
         }
      }
            ...
            if(!this.func_70648_aU() && !this.func_82165_m(Potion.field_76427_o.field_76415_H) && !lvt_2_2_) {
               ...
               if(this.func_70086_ai() == -20) {
                  ...
                  for(int lvt_3_1_ = 0; lvt_3_1_ < 8; ++lvt_3_1_) {
                     ...
                     this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t + (double)lvt_4_1_, this.field_70163_u + (double)lvt_5_1_, this.field_70161_v + (double)lvt_6_1_, this.field_70159_w, this.field_70181_x, this.field_70179_y, new int[0]);
                  }
   ...
   protected void func_70609_aI() {
      ...
      if(this.field_70725_aQ == 20) {
         if(!this.field_70170_p.field_72995_K && (this.field_70718_bc > 0 || this.func_70684_aJ()) && this.func_146066_aG() && this.field_70170_p.func_82736_K().func_82766_b("doMobLoot")) {
            int lvt_1_1_ = this.func_70693_a(this.field_70717_bb);

            while(lvt_1_1_ > 0) {
               int lvt_2_1_ = EntityXPOrb.func_70527_a(lvt_1_1_);
               lvt_1_1_ -= lvt_2_1_;
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      for(ItemStack lvt_5_1_ : this.func_70035_c()) {
         if(lvt_5_1_ != null) {
            this.field_110155_d.func_111148_a(lvt_5_1_.func_111283_C());
         }
      }

      p_70014_1_.func_74782_a("Attributes", SharedMonsterAttributes.func_111257_a(this.func_110140_aT()));

      for(ItemStack lvt_5_2_ : this.func_70035_c()) {
         if(lvt_5_2_ != null) {
      ...
      if(!this.field_70713_bf.isEmpty()) {
         ...
         for(PotionEffect lvt_4_3_ : this.field_70713_bf.values()) {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("ActiveEffects", 9)) {
         ...
         for(int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_.func_74745_c(); ++lvt_3_1_) {
            ...
            if(lvt_5_1_ != null) {
               this.field_70713_bf.put(Integer.valueOf(lvt_5_1_.func_76456_a()), lvt_5_1_);
            }
         }
      }
   ...
   protected void func_70679_bo() {
      Iterator<Integer> lvt_1_1_ = this.field_70713_bf.keySet().iterator();
   ...
   protected void func_175135_B() {
      if(this.field_70713_bf.isEmpty()) {
         ...
         this.field_70180_af.func_75692_b(7, Integer.valueOf(lvt_1_1_));
   ...
   public void func_82170_o(int p_82170_1_) {
      PotionEffect lvt_2_1_ = (PotionEffect)this.field_70713_bf.remove(Integer.valueOf(p_82170_1_));
      if(lvt_2_1_ != null) {
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, float p_70097_2_) {
      if(this.func_180431_b(p_70097_1_)) {
         ...
         if(this.func_110143_aJ() <= 0.0F) {
            ...
            if(this.func_110143_aJ() <= 0.0F) {
               String lvt_5_3_ = this.func_70673_aS();
               ...
               String lvt_5_4_ = this.func_70621_aR();
               if(lvt_3_1_ && lvt_5_4_ != null) {
                  this.func_85030_a(lvt_5_4_, this.func_70599_aP(), this.func_70647_i());
               }
            }
   ...
   public void func_70669_a(ItemStack p_70669_1_) {
      ...
      for(int lvt_2_1_ = 0; lvt_2_1_ < 5; ++lvt_2_1_) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.ITEM_CRACK, lvt_6_1_.field_72450_a, lvt_6_1_.field_72448_b, lvt_6_1_.field_72449_c, lvt_3_1_.field_72450_a, lvt_3_1_.field_72448_b + 0.05D, lvt_3_1_.field_72449_c, new int[]{Item.func_150891_b(p_70669_1_.func_77973_b())});
      }
   ...
   protected float func_70672_c(DamageSource p_70672_1_, float p_70672_2_) {
      if(p_70672_1_.func_151517_h()) {
         ...
         if(this.func_70644_a(Potion.field_76429_m) && p_70672_1_ != DamageSource.field_76380_i) {
            int lvt_3_1_ = (this.func_70660_b(Potion.field_76429_m).func_76458_c() + 1) * 5;
            int lvt_4_1_ = 25 - lvt_3_1_;
            float lvt_5_1_ = p_70672_2_ * (float)lvt_4_1_;
            p_70672_2_ = lvt_5_1_ / 25.0F;
         }

         if(p_70672_2_ <= 0.0F) {
            return 0.0F;
         } else {
            int lvt_3_2_ = EnchantmentHelper.func_77508_a(this.func_70035_c(), p_70672_1_);
            if(lvt_3_2_ > 20) {
               lvt_3_2_ = 20;
            }
            ...
            if(lvt_3_2_ > 0 && lvt_3_2_ <= 20) {
               ...
               float lvt_5_2_ = p_70672_2_ * (float)lvt_4_2_;
   ...
   public void func_70103_a(byte p_70103_1_) {
      if(p_70103_1_ == 2) {
         ...
         this.field_70737_aN = this.field_70738_aO = 10;
         this.field_70739_aP = 0.0F;
         String lvt_2_1_ = this.func_70621_aR();
         if(lvt_2_1_ != null) {
         ...
         String lvt_2_2_ = this.func_70673_aS();
         if(lvt_2_2_ != null) {
   ...
   public void func_70612_e(float p_70612_1_, float p_70612_2_) {
      if(this.func_70613_aW()) {
         if(!this.func_70090_H() || this instanceof EntityPlayer && ((EntityPlayer)this).field_71075_bZ.field_75100_b) {
            if(!this.func_180799_ab() || this instanceof EntityPlayer && ((EntityPlayer)this).field_71075_bZ.field_75100_b) {
               ...
               float lvt_5_2_;
               if(this.field_70122_E) {
                  lvt_5_2_ = this.func_70689_ay() * lvt_4_1_;
               } else {
                  lvt_5_2_ = this.field_70747_aH;
               }

               this.func_70060_a(p_70612_1_, p_70612_2_, lvt_5_2_);
               lvt_3_3_ = 0.91F;
               if(this.field_70122_E) {
                  lvt_3_3_ = this.field_70170_p.func_180495_p(new BlockPos(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.func_174813_aQ().field_72338_b) - 1, MathHelper.func_76128_c(this.field_70161_v))).func_177230_c().field_149765_K * 0.91F;
               }
               ...
               double lvt_3_2_ = this.field_70163_u;
               ...
               if(this.field_70123_F && this.func_70038_c(this.field_70159_w, this.field_70181_x + 0.6000000238418579D - this.field_70163_u + lvt_3_2_, this.field_70179_y)) {
            ...
            float lvt_7_1_ = (float)EnchantmentHelper.func_180318_b(this);
            if(lvt_7_1_ > 3.0F) {
               lvt_7_1_ = 3.0F;
            }
            ...
            if(lvt_7_1_ > 0.0F) {
               ...
               lvt_6_1_ += (this.func_70689_ay() * 1.0F - lvt_6_1_) * lvt_7_1_ / 3.0F;
            }

            this.func_70060_a(p_70612_1_, p_70612_2_, lvt_6_1_);
            this.func_70091_d(this.field_70159_w, this.field_70181_x, this.field_70179_y);
            this.field_70159_w *= (double)lvt_5_1_;
            this.field_70181_x *= 0.800000011920929D;
            this.field_70179_y *= (double)lvt_5_1_;
            this.field_70181_x -= 0.02D;
      ...
      double lvt_3_4_ = this.field_70165_t - this.field_70169_q;
      double lvt_5_4_ = this.field_70161_v - this.field_70166_s;
      float lvt_7_3_ = MathHelper.func_76133_a(lvt_3_4_ * lvt_3_4_ + lvt_5_4_ * lvt_5_4_) * 4.0F;
      if(lvt_7_3_ > 1.0F) {
         lvt_7_3_ = 1.0F;
      }

      this.field_70721_aZ += (lvt_7_3_ - this.field_70721_aZ) * 0.4F;
