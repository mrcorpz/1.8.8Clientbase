...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock {
   ...
   public void func_75246_d() {
      ...
      if(this.func_179487_f()) {
         ...
         if(this.field_179501_f == 0 && lvt_4_1_ instanceof BlockCrops && ((Integer)lvt_3_1_.func_177229_b(BlockCrops.field_176488_a)).intValue() == 7) {
   ...
   protected boolean func_179488_a(World p_179488_1_, BlockPos p_179488_2_) {
      ...
      if(lvt_3_1_ == Blocks.field_150458_ak) {
         ...
         if(lvt_3_1_ instanceof BlockCrops && ((Integer)lvt_4_1_.func_177229_b(BlockCrops.field_176488_a)).intValue() == 7 && this.field_179503_e && (this.field_179501_f == 0 || this.field_179501_f < 0)) {
