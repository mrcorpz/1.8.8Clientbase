...
public class EntityAIAttackOnCollide extends EntityAIBase {
   ...
   public boolean func_75253_b() {
      EntityLivingBase lvt_1_1_ = this.field_75441_b.func_70638_az();
      return lvt_1_1_ == null?false:(!lvt_1_1_.func_70089_S()?false:(!this.field_75437_f?!this.field_75441_b.func_70661_as().func_75500_f():this.field_75441_b.func_180485_d(new BlockPos(lvt_1_1_))));
   }
