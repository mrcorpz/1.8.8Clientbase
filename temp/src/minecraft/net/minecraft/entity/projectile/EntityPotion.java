   ...
   protected void func_70184_a(MovingObjectPosition p_70184_1_) {
      if(!this.field_70170_p.field_72995_K) {
         ...
         if(lvt_2_1_ != null && !lvt_2_1_.isEmpty()) {
            ...
            List<EntityLivingBase> lvt_4_1_ = this.field_70170_p.<EntityLivingBase>func_72872_a(EntityLivingBase.class, lvt_3_1_);
            if(!lvt_4_1_.isEmpty()) {
               for(EntityLivingBase lvt_6_1_ : lvt_4_1_) {
                  double lvt_7_1_ = this.func_70068_e(lvt_6_1_);
                  if(lvt_7_1_ < 16.0D) {
