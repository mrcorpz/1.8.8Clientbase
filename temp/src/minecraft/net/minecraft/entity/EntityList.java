...
public class EntityList {
   ...
   public static Entity func_75620_a(String p_75620_0_, World p_75620_1_) {
      ...
      try {
         ...
         if(lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75620_1_});
         }
   ...
   public static Entity func_75615_a(NBTTagCompound p_75615_0_, World p_75615_1_) {
      ...
      try {
         ...
         if(lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75615_1_});
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
   ...
   public static Entity func_75616_a(int p_75616_0_, World p_75616_1_) {
      ...
      try {
         ...
         if(lvt_3_1_ != null) {
            lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75616_1_});
         }
      } catch (Exception var4) {
         var4.printStackTrace();
      }
