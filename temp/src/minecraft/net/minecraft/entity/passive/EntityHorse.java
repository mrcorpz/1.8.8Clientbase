...
public class EntityHorse extends EntityAnimal implements IInvBasic {
   ...
   private void func_110208_b(int p_110208_1_, boolean p_110208_2_) {
      ...
      if(p_110208_2_) {
         this.field_70180_af.func_75692_b(16, Integer.valueOf(lvt_3_1_ | p_110208_1_));
      } else {
         this.field_70180_af.func_75692_b(16, Integer.valueOf(lvt_3_1_ & ~p_110208_1_));
      }
   ...
   private int func_110260_d(ItemStack p_110260_1_) {
      if(p_110260_1_ == null) {
         ...
         return lvt_2_1_ == Items.field_151138_bX?1:(lvt_2_1_ == Items.field_151136_bY?2:(lvt_2_1_ == Items.field_151125_bZ?3:0));
      }
   }
   ...
   protected EntityHorse func_110250_a(Entity p_110250_1_, double p_110250_2_) {
      ...
      for(Entity lvt_9_1_ : this.field_70170_p.func_175674_a(p_110250_1_, p_110250_1_.func_174813_aQ().func_72321_a(p_110250_2_, p_110250_2_, p_110250_2_), field_110276_bu)) {
   ...
   protected Item func_146068_u() {
      ...
      return lvt_2_1_ == 4?Items.field_151103_aS:(lvt_2_1_ == 3?(lvt_1_1_?null:Items.field_151078_bh):Items.field_151116_aA);
   }
   ...
   private void func_110247_cG() {
      ...
      if(lvt_1_1_ == 0) {
         ...
         if(lvt_3_1_ >= field_110268_bz.length) {
            this.field_175508_bO = false;
            return;
         }

         this.field_110280_bR[0] = field_110268_bz[lvt_3_1_];
         this.field_110286_bQ = this.field_110286_bQ + field_110269_bA[lvt_3_1_];
      ...
      int lvt_3_2_ = this.func_110241_cb();
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("ArmorItem", 10)) {
         ItemStack lvt_4_2_ = ItemStack.func_77949_a(p_70037_1_.func_74775_l("ArmorItem"));
         if(lvt_4_2_ != null && func_146085_a(lvt_4_2_.func_77973_b())) {
            this.field_110296_bG.func_70299_a(1, lvt_4_2_);
         }
      }

      if(p_70037_1_.func_150297_b("SaddleItem", 10)) {
         ItemStack lvt_4_3_ = ItemStack.func_77949_a(p_70037_1_.func_74775_l("SaddleItem"));
   ...
   public EntityAgeable func_90011_a(EntityAgeable p_90011_1_) {
      ...
      if(lvt_6_1_ == 0) {
         ...
         int lvt_7_1_;
         if(lvt_8_1_ < 4) {
            lvt_7_1_ = this.func_110202_bQ() & 255;
         } else if(lvt_8_1_ < 8) {
            lvt_7_1_ = lvt_2_1_.func_110202_bQ() & 255;
         } else {
            lvt_7_1_ = this.field_70146_Z.nextInt(7);
         }

         int lvt_9_1_ = this.field_70146_Z.nextInt(5);
         if(lvt_9_1_ < 2) {
            lvt_7_1_ = lvt_7_1_ | this.func_110202_bQ() & '\uff00';
         } else if(lvt_9_1_ < 4) {
            lvt_7_1_ = lvt_7_1_ | lvt_2_1_.func_110202_bQ() & '\uff00';
         } else {
            lvt_7_1_ = lvt_7_1_ | this.field_70146_Z.nextInt(5) << 8 & '\uff00';
         }

         lvt_3_1_.func_110235_q(lvt_7_1_);
      }
