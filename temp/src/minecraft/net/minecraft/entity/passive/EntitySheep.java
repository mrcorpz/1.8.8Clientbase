...
public class EntitySheep extends EntityAnimal {
   ...
   public void func_175512_b(EnumDyeColor p_175512_1_) {
      ...
      this.field_70180_af.func_75692_b(16, Byte.valueOf((byte)(lvt_2_1_ & 240 | p_175512_1_.func_176765_a() & 15)));
   }
   ...
   public void func_70893_e(boolean p_70893_1_) {
      byte lvt_2_1_ = this.field_70180_af.func_75683_a(16);
      if(p_70893_1_) {
         this.field_70180_af.func_75692_b(16, Byte.valueOf((byte)(lvt_2_1_ | 16)));
      } else {
         this.field_70180_af.func_75692_b(16, Byte.valueOf((byte)(lvt_2_1_ & -17)));
      }
   ...
   public static EnumDyeColor func_175510_a(Random p_175510_0_) {
      ...
      return lvt_1_1_ < 5?EnumDyeColor.BLACK:(lvt_1_1_ < 10?EnumDyeColor.GRAY:(lvt_1_1_ < 15?EnumDyeColor.SILVER:(lvt_1_1_ < 18?EnumDyeColor.BROWN:(p_175510_0_.nextInt(500) == 0?EnumDyeColor.PINK:EnumDyeColor.WHITE))));
   }
   ...
   private EnumDyeColor func_175511_a(EntityAnimal p_175511_1_, EntityAnimal p_175511_2_) {
      ...
      if(lvt_5_1_ != null && lvt_5_1_.func_77973_b() == Items.field_151100_aR) {
         lvt_6_1_ = lvt_5_1_.func_77960_j();
      } else {
         lvt_6_1_ = this.field_70170_p.field_73012_v.nextBoolean()?lvt_3_1_:lvt_4_1_;
      }

      return EnumDyeColor.func_176766_a(lvt_6_1_);
   }
