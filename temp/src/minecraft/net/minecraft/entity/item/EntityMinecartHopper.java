...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper {
   ...
   public boolean func_96112_aD() {
      if(TileEntityHopper.func_145891_a(this)) {
         ...
         List<EntityItem> lvt_1_1_ = this.field_70170_p.<EntityItem>func_175647_a(EntityItem.class, this.func_174813_aQ().func_72314_b(0.25D, 0.0D, 0.25D), EntitySelectors.field_94557_a);
         if(lvt_1_1_.size() > 0) {
