...
public class EntityFallingBlock extends Entity {
   ...
   public void func_70071_h_() {
      ...
      if(lvt_1_1_.func_149688_o() == Material.field_151579_a) {
         ...
         if(this.field_145812_b++ == 0) {
            ...
            if(this.field_70170_p.func_180495_p(lvt_2_1_).func_177230_c() == lvt_1_1_) {
               this.field_70170_p.func_175698_g(lvt_2_1_);
                     ...
                     if(this.field_70170_p.func_175716_a(lvt_1_1_, lvt_2_2_, true, EnumFacing.UP, (Entity)null, (ItemStack)null) && !BlockFalling.func_180685_d(this.field_70170_p, lvt_2_2_.func_177977_b()) && this.field_70170_p.func_180501_a(lvt_2_2_, this.field_175132_d, 3)) {
                        ...
                        if(this.field_145810_d != null && lvt_1_1_ instanceof ITileEntityProvider) {
                           ...
                           if(lvt_3_1_ != null) {
                              ...
                              for(String lvt_6_1_ : this.field_145810_d.func_150296_c()) {
   ...
   public void func_180430_e(float p_180430_1_, float p_180430_2_) {
      ...
      if(this.field_145809_g) {
         ...
         if(lvt_4_1_ > 0) {
            List<Entity> lvt_5_1_ = Lists.newArrayList(this.field_70170_p.func_72839_b(this, this.func_174813_aQ()));
            ...
            if(lvt_6_1_ && (double)this.field_70146_Z.nextFloat() < 0.05000000074505806D + (double)lvt_4_1_ * 0.05D) {
               int lvt_8_2_ = ((Integer)this.field_175132_d.func_177229_b(BlockAnvil.field_176505_b)).intValue();
               ++lvt_8_2_;
               if(lvt_8_2_ > 2) {
                  this.field_145808_f = true;
               } else {
                  this.field_175132_d = this.field_175132_d.func_177226_a(BlockAnvil.field_176505_b, Integer.valueOf(lvt_8_2_));
               }
            }
         }
      }
   ...
   public void func_85029_a(CrashReportCategory p_85029_1_) {
      ...
      if(this.field_175132_d != null) {
         ...
         p_85029_1_.func_71507_a("Immitating block ID", Integer.valueOf(Block.func_149682_b(lvt_2_1_)));
         p_85029_1_.func_71507_a("Immitating block data", Integer.valueOf(lvt_2_1_.func_176201_c(this.field_175132_d)));
      }
