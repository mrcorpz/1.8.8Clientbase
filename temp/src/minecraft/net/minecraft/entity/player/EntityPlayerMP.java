...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   public void func_70071_h_() {
      ...
      if(!this.field_71129_f.isEmpty()) {
         ...
         while(lvt_2_2_.hasNext() && ((List)lvt_1_2_).size() < 10) {
            ...
            if(lvt_4_2_ != null) {
               if(this.field_70170_p.func_175667_e(new BlockPos(lvt_4_2_.field_77276_a << 4, 0, lvt_4_2_.field_77275_b << 4))) {
                  Chunk lvt_5_1_ = this.field_70170_p.func_72964_e(lvt_4_2_.field_77276_a, lvt_4_2_.field_77275_b);
                  if(lvt_5_1_.func_150802_k()) {
         ...
         if(!lvt_1_2_.isEmpty()) {
            if(lvt_1_2_.size() == 1) {
               this.field_71135_a.func_147359_a(new S21PacketChunkData((Chunk)lvt_1_2_.get(0), true, '\uffff'));
            } else {
   ...
   public void func_71127_g() {
      try {
         ...
         if(this.func_110143_aJ() + this.func_110139_bj() != this.field_130068_bO) {
            ...
            for(ScoreObjective lvt_3_2_ : this.func_96123_co().func_96520_a(IScoreObjectiveCriteria.field_96638_f)) {
               this.func_96123_co().func_96529_a(this.func_70005_c_(), lvt_3_2_).func_96651_a(Arrays.asList(new EntityPlayer[]{this}));
            }
         }
   ...
   protected void func_147098_j() {
      ...
      if(this.func_147099_x().func_77442_b(AchievementList.field_150961_L) && lvt_3_1_.size() >= BiomeGenBase.field_150597_n.size()) {
         Set<BiomeGenBase> lvt_4_1_ = Sets.newHashSet(BiomeGenBase.field_150597_n);
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      for(ScoreObjective lvt_4_1_ : this.field_70170_p.func_96441_U().func_96520_a(IScoreObjectiveCriteria.field_96642_c)) {
      ...
      if(lvt_3_2_ != null) {
         EntityList.EntityEggInfo lvt_4_2_ = (EntityList.EntityEggInfo)EntityList.field_75627_a.get(Integer.valueOf(EntityList.func_75619_a(lvt_3_2_)));
         if(lvt_4_2_ != null) {
   ...
   public void func_71064_a(StatBase p_71064_1_, int p_71064_2_) {
      if(p_71064_1_ != null) {
         ...
         for(ScoreObjective lvt_4_1_ : this.func_96123_co().func_96520_a(p_71064_1_.func_150952_k())) {
   ...
   public void func_175145_a(StatBase p_175145_1_) {
      if(p_175145_1_ != null) {
         ...
         for(ScoreObjective lvt_3_1_ : this.func_96123_co().func_96520_a(p_175145_1_.func_150952_k())) {
   ...
   public boolean func_70003_b(int p_70003_1_, String p_70003_2_) {
      if("seed".equals(p_70003_2_) && !this.field_71133_b.func_71262_S()) {
         ...
         if(this.field_71133_b.func_71203_ab().func_152596_g(this.func_146103_bH())) {
            ...
            return lvt_3_1_ != null?lvt_3_1_.func_152644_a() >= p_70003_1_:this.field_71133_b.func_110455_j() >= p_70003_1_;
         } else {
            return false;
         }
      } else {
