...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, IInventory {
   ...
   private void func_146000_x() {
      if(this.field_146015_k && this.field_146012_l > 0 && !this.field_145850_b.field_72995_K && this.field_146013_m > 0) {
         ...
         List<EntityPlayer> lvt_8_1_ = this.field_145850_b.<EntityPlayer>func_72872_a(EntityPlayer.class, lvt_7_1_);

         for(EntityPlayer lvt_10_1_ : lvt_8_1_) {
            lvt_10_1_.func_70690_d(new PotionEffect(this.field_146013_m, 180, lvt_3_1_, true, true));
         }
   ...
   private void func_146003_y() {
      ...
      for(int lvt_8_1_ = lvt_3_1_ + 1; lvt_8_1_ < 256; ++lvt_8_1_) {
         IBlockState lvt_9_1_ = this.field_145850_b.func_180495_p(lvt_7_1_.func_181079_c(lvt_2_1_, lvt_8_1_, lvt_4_1_));
         float[] lvt_10_1_;
         if(lvt_9_1_.func_177230_c() == Blocks.field_150399_cn) {
            lvt_10_1_ = EntitySheep.func_175513_a((EnumDyeColor)lvt_9_1_.func_177229_b(BlockStainedGlass.field_176547_a));
         } else {
            ...
            lvt_10_1_ = EntitySheep.func_175513_a((EnumDyeColor)lvt_9_1_.func_177229_b(BlockStainedGlassPane.field_176245_a));
         }

         if(!lvt_6_1_) {
            lvt_10_1_ = new float[]{(lvt_5_1_.func_177263_b()[0] + lvt_10_1_[0]) / 2.0F, (lvt_5_1_.func_177263_b()[1] + lvt_10_1_[1]) / 2.0F, (lvt_5_1_.func_177263_b()[2] + lvt_10_1_[2]) / 2.0F};
         }

         if(Arrays.equals(lvt_10_1_, lvt_5_1_.func_177263_b())) {
            lvt_5_1_.func_177262_a();
         } else {
      ...
      if(this.field_146015_k) {
         for(int lvt_8_2_ = 1; lvt_8_2_ <= 4; this.field_146012_l = lvt_8_2_++) {
      ...
      if(!this.field_145850_b.field_72995_K && this.field_146012_l == 4 && lvt_1_1_ < this.field_146012_l) {
         for(EntityPlayer lvt_9_3_ : this.field_145850_b.func_72872_a(EntityPlayer.class, (new AxisAlignedBB((double)lvt_2_1_, (double)lvt_3_1_, (double)lvt_4_1_, (double)lvt_2_1_, (double)(lvt_3_1_ - 4), (double)lvt_4_1_)).func_72314_b(10.0D, 5.0D, 10.0D))) {
