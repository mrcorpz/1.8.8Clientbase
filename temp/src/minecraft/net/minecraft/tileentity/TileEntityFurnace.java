...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      if(this.field_145957_n[p_70298_1_] != null) {
         if(this.field_145957_n[p_70298_1_].field_77994_a <= p_70298_2_) {
            ItemStack lvt_3_1_ = this.field_145957_n[p_70298_1_];
            this.field_145957_n[p_70298_1_] = null;
            return lvt_3_1_;
         } else {
            ItemStack lvt_3_2_ = this.field_145957_n[p_70298_1_].func_77979_a(p_70298_2_);
   ...
   private boolean func_145948_k() {
      if(this.field_145957_n[0] == null) {
         ...
         return lvt_1_1_ == null?false:(this.field_145957_n[2] == null?true:(!this.field_145957_n[2].func_77969_a(lvt_1_1_)?false:(this.field_145957_n[2].field_77994_a < this.func_70297_j_() && this.field_145957_n[2].field_77994_a < this.field_145957_n[2].func_77976_d()?true:this.field_145957_n[2].field_77994_a < lvt_1_1_.func_77976_d())));
      }
   }
   ...
   public static int func_145952_a(ItemStack p_145952_0_) {
      if(p_145952_0_ == null) {
         ...
         return lvt_1_1_ instanceof ItemTool && ((ItemTool)lvt_1_1_).func_77861_e().equals("WOOD")?200:(lvt_1_1_ instanceof ItemSword && ((ItemSword)lvt_1_1_).func_150932_j().equals("WOOD")?200:(lvt_1_1_ instanceof ItemHoe && ((ItemHoe)lvt_1_1_).func_77842_f().equals("WOOD")?200:(lvt_1_1_ == Items.field_151055_y?100:(lvt_1_1_ == Items.field_151044_h?1600:(lvt_1_1_ == Items.field_151129_at?20000:(lvt_1_1_ == Item.func_150898_a(Blocks.field_150345_g)?100:(lvt_1_1_ == Items.field_151072_bj?2400:0)))))));
      }
   }
