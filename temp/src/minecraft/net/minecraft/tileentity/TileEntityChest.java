...
public class TileEntityChest extends TileEntityLockable implements ITickable, IInventory {
   ...
   public ItemStack func_70298_a(int p_70298_1_, int p_70298_2_) {
      if(this.field_145985_p[p_70298_1_] != null) {
         if(this.field_145985_p[p_70298_1_].field_77994_a <= p_70298_2_) {
            ItemStack lvt_3_1_ = this.field_145985_p[p_70298_1_];
            this.field_145985_p[p_70298_1_] = null;
            this.func_70296_d();
            return lvt_3_1_;
         } else {
            ItemStack lvt_3_2_ = this.field_145985_p[p_70298_1_].func_77979_a(p_70298_2_);
   ...
   public void func_73660_a() {
      ...
      if(!this.field_145850_b.field_72995_K && this.field_145987_o != 0 && (this.field_145983_q + lvt_1_1_ + lvt_2_1_ + lvt_3_1_) % 200 == 0) {
         ...
         for(EntityPlayer lvt_7_1_ : this.field_145850_b.func_72872_a(EntityPlayer.class, new AxisAlignedBB((double)((float)lvt_1_1_ - lvt_4_1_), (double)((float)lvt_2_1_ - lvt_4_1_), (double)((float)lvt_3_1_ - lvt_4_1_), (double)((float)(lvt_1_1_ + 1) + lvt_4_1_), (double)((float)(lvt_2_1_ + 1) + lvt_4_1_), (double)((float)(lvt_3_1_ + 1) + lvt_4_1_)))) {
            if(lvt_7_1_.field_71070_bA instanceof ContainerChest) {
               IInventory lvt_8_1_ = ((ContainerChest)lvt_7_1_.field_71070_bA).func_85151_d();
               if(lvt_8_1_ == this || lvt_8_1_ instanceof InventoryLargeChest && ((InventoryLargeChest)lvt_8_1_).func_90010_a(this)) {
                  ++this.field_145987_o;
               }
            }
         }
      ...
      if(this.field_145987_o > 0 && this.field_145989_m == 0.0F && this.field_145992_i == null && this.field_145991_k == null) {
         ...
         this.field_145850_b.func_72908_a(lvt_5_2_, (double)lvt_2_1_ + 0.5D, lvt_7_2_, "random.chestopen", 0.5F, this.field_145850_b.field_73012_v.nextFloat() * 0.1F + 0.9F);
      }
