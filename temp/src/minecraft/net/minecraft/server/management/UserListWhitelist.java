...
public class UserListWhitelist extends UserList<GameProfile, UserListWhitelistEntry> {
   ...
   public String[] func_152685_a() {
      ...
      for(UserListWhitelistEntry lvt_4_1_ : this.func_152688_e().values()) {
   ...
   public GameProfile func_152706_a(String p_152706_1_) {
      for(UserListWhitelistEntry lvt_3_1_ : this.func_152688_e().values()) {
         if(p_152706_1_.equalsIgnoreCase(((GameProfile)lvt_3_1_.func_152640_f()).getName())) {
