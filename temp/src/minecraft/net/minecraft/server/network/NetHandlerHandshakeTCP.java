   ...
   public void func_147383_a(C00Handshake p_147383_1_) {
      ...
      case LOGIN:
         ...
         if(p_147383_1_.func_149595_d() > 47) {
            ChatComponentText lvt_2_1_ = new ChatComponentText("Outdated server! I\'m still on 1.8.8");
            ...
            ChatComponentText lvt_2_2_ = new ChatComponentText("Outdated client! Please use 1.8.8");
