...
public class ExtendedBlockStorage {
   ...
   public IBlockState func_177485_a(int p_177485_1_, int p_177485_2_, int p_177485_3_) {
      IBlockState lvt_4_1_ = (IBlockState)Block.field_176229_d.func_148745_a(this.field_177488_d[p_177485_2_ << 8 | p_177485_3_ << 4 | p_177485_1_]);
      return lvt_4_1_ != null?lvt_4_1_:Blocks.field_150350_a.func_176223_P();
   }

   public void func_177484_a(int p_177484_1_, int p_177484_2_, int p_177484_3_, IBlockState p_177484_4_) {
      IBlockState lvt_5_1_ = this.func_177485_a(p_177484_1_, p_177484_2_, p_177484_3_);
      Block lvt_6_1_ = lvt_5_1_.func_177230_c();
      Block lvt_7_1_ = p_177484_4_.func_177230_c();
      if(lvt_6_1_ != Blocks.field_150350_a) {
         --this.field_76682_b;
         if(lvt_6_1_.func_149653_t()) {
            --this.field_76683_c;
         }
      }

      if(lvt_7_1_ != Blocks.field_150350_a) {
         ++this.field_76682_b;
         if(lvt_7_1_.func_149653_t()) {
            ++this.field_76683_c;
         }
      }
   ...
   public int func_76665_b(int p_76665_1_, int p_76665_2_, int p_76665_3_) {
      IBlockState lvt_4_1_ = this.func_177485_a(p_76665_1_, p_76665_2_, p_76665_3_);
      return lvt_4_1_.func_177230_c().func_176201_c(lvt_4_1_);
   }
      ...
      for(int lvt_1_1_ = 0; lvt_1_1_ < 16; ++lvt_1_1_) {
         for(int lvt_2_1_ = 0; lvt_2_1_ < 16; ++lvt_2_1_) {
            for(int lvt_3_1_ = 0; lvt_3_1_ < 16; ++lvt_3_1_) {
               Block lvt_4_1_ = this.func_150819_a(lvt_1_1_, lvt_2_1_, lvt_3_1_);
               if(lvt_4_1_ != Blocks.field_150350_a) {
                  ++this.field_76682_b;
                  if(lvt_4_1_.func_149653_t()) {
                     ++this.field_76683_c;
                  }
               }
            }
