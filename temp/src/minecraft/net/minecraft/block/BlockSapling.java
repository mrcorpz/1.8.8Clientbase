...
public class BlockSapling extends BlockBush implements IGrowable {
   ...
   public void func_176476_e(World p_176476_1_, BlockPos p_176476_2_, IBlockState p_176476_3_, Random p_176476_4_) {
      WorldGenerator lvt_5_1_ = (WorldGenerator)(p_176476_4_.nextInt(10) == 0?new WorldGenBigTree(true):new WorldGenTrees(true));
      int lvt_6_1_ = 0;
      int lvt_7_1_ = 0;
      ...
      case BIRCH:
         ...
         break;
      case JUNGLE:
         IBlockState lvt_9_1_ = Blocks.field_150364_r.func_176223_P().func_177226_a(BlockOldLog.field_176301_b, BlockPlanks.EnumType.JUNGLE);
         IBlockState lvt_10_1_ = Blocks.field_150362_t.func_176223_P().func_177226_a(BlockOldLeaf.field_176239_P, BlockPlanks.EnumType.JUNGLE).func_177226_a(BlockLeaves.field_176236_b, Boolean.valueOf(false));
      ...
      IBlockState lvt_9_2_ = Blocks.field_150350_a.func_176223_P();
      if(lvt_8_1_) {
         p_176476_1_.func_180501_a(p_176476_2_.func_177982_a(lvt_6_1_, 0, lvt_7_1_), lvt_9_2_, 4);
         p_176476_1_.func_180501_a(p_176476_2_.func_177982_a(lvt_6_1_ + 1, 0, lvt_7_1_), lvt_9_2_, 4);
         p_176476_1_.func_180501_a(p_176476_2_.func_177982_a(lvt_6_1_, 0, lvt_7_1_ + 1), lvt_9_2_, 4);
         p_176476_1_.func_180501_a(p_176476_2_.func_177982_a(lvt_6_1_ + 1, 0, lvt_7_1_ + 1), lvt_9_2_, 4);
      } else {
         p_176476_1_.func_180501_a(p_176476_2_, lvt_9_2_, 4);
      }

      if(!lvt_5_1_.func_180709_b(p_176476_1_, p_176476_4_, p_176476_2_.func_177982_a(lvt_6_1_, 0, lvt_7_1_))) {
         if(lvt_8_1_) {
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | ((BlockPlanks.EnumType)p_176201_1_.func_177229_b(field_176480_a)).func_176839_a();
      lvt_2_1_ = lvt_2_1_ | ((Integer)p_176201_1_.func_177229_b(field_176479_b)).intValue() << 3;
      return lvt_2_1_;
   }
