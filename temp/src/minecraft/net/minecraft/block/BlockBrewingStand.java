...
public class BlockBrewingStand extends BlockContainer {
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      ...
      p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, lvt_5_1_, lvt_7_1_, lvt_9_1_, 0.0D, 0.0D, 0.0D, new int[0]);
   }
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < 3; ++lvt_3_1_) {
         lvt_2_1_ = lvt_2_1_.func_177226_a(field_176451_a[lvt_3_1_], Boolean.valueOf((p_176203_1_ & 1 << lvt_3_1_) > 0));
      }
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      ...
      for(int lvt_3_1_ = 0; lvt_3_1_ < 3; ++lvt_3_1_) {
         if(((Boolean)p_176201_1_.func_177229_b(field_176451_a[lvt_3_1_])).booleanValue()) {
            lvt_2_1_ |= 1 << lvt_3_1_;
         }
      }
