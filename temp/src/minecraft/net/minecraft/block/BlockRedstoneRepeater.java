...
public class BlockRedstoneRepeater extends BlockRedstoneDiode {
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      if(this.field_149914_a) {
         ...
         if(p_180655_4_.nextBoolean()) {
            lvt_12_1_ = (float)(((Integer)p_180655_3_.func_177229_b(field_176410_b)).intValue() * 2 - 1);
         }
         ...
         p_180655_1_.func_175688_a(EnumParticleTypes.REDSTONE, lvt_6_1_ + lvt_13_1_, lvt_8_1_, lvt_10_1_ + lvt_15_1_, 0.0D, 0.0D, 0.0D, new int[0]);
      }
   }
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      ...
      lvt_2_1_ = lvt_2_1_ | ((Integer)p_176201_1_.func_177229_b(field_176410_b)).intValue() - 1 << 2;
      return lvt_2_1_;
   }
