...
public class BlockHopper extends BlockContainer {
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      ...
      return this.func_176223_P().func_177226_a(field_176430_a, lvt_9_1_).func_177226_a(field_176429_b, Boolean.valueOf(true));
   }
   ...
   private void func_176427_e(World p_176427_1_, BlockPos p_176427_2_, IBlockState p_176427_3_) {
      ...
      if(lvt_4_1_ != ((Boolean)p_176427_3_.func_177229_b(field_176429_b)).booleanValue()) {
         p_176427_1_.func_180501_a(p_176427_2_, p_176427_3_.func_177226_a(field_176429_b, Boolean.valueOf(lvt_4_1_)), 4);
      }
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | ((EnumFacing)p_176201_1_.func_177229_b(field_176430_a)).func_176745_a();
