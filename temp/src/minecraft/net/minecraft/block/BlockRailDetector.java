...
public class BlockRailDetector extends BlockRailBase {
   ...
   private void func_176570_e(World p_176570_1_, BlockPos p_176570_2_, IBlockState p_176570_3_) {
      boolean lvt_4_1_ = ((Boolean)p_176570_3_.func_177229_b(field_176574_M)).booleanValue();
      boolean lvt_5_1_ = false;
      List<EntityMinecart> lvt_6_1_ = this.<EntityMinecart>func_176571_a(p_176570_1_, p_176570_2_, EntityMinecart.class, new Predicate[0]);
      if(!lvt_6_1_.isEmpty()) {
         lvt_5_1_ = true;
      }
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      if(((Boolean)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176574_M)).booleanValue()) {
         List<EntityMinecartCommandBlock> lvt_3_1_ = this.<EntityMinecartCommandBlock>func_176571_a(p_180641_1_, p_180641_2_, EntityMinecartCommandBlock.class, new Predicate[0]);
         if(!lvt_3_1_.isEmpty()) {
            return ((EntityMinecartCommandBlock)lvt_3_1_.get(0)).func_145822_e().func_145760_g();
         }

         List<EntityMinecart> lvt_4_1_ = this.<EntityMinecart>func_176571_a(p_180641_1_, p_180641_2_, EntityMinecart.class, new Predicate[]{EntitySelectors.field_96566_b});
         if(!lvt_4_1_.isEmpty()) {
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | ((BlockRailBase.EnumRailDirection)p_176201_1_.func_177229_b(field_176573_b)).func_177015_a();
