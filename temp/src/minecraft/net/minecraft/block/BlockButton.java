...
public abstract class BlockButton extends Block {
   ...
   private void func_180681_d(IBlockState p_180681_1_) {
      ...
      boolean lvt_3_1_ = ((Boolean)p_180681_1_.func_177229_b(field_176584_b)).booleanValue();
   ...
   private void func_180680_f(World p_180680_1_, BlockPos p_180680_2_, IBlockState p_180680_3_) {
      ...
      List<? extends Entity> lvt_4_1_ = p_180680_1_.<Entity>func_72872_a(EntityArrow.class, new AxisAlignedBB((double)p_180680_2_.func_177958_n() + this.field_149759_B, (double)p_180680_2_.func_177956_o() + this.field_149760_C, (double)p_180680_2_.func_177952_p() + this.field_149754_D, (double)p_180680_2_.func_177958_n() + this.field_149755_E, (double)p_180680_2_.func_177956_o() + this.field_149756_F, (double)p_180680_2_.func_177952_p() + this.field_149757_G));
      boolean lvt_5_1_ = !lvt_4_1_.isEmpty();
      boolean lvt_6_1_ = ((Boolean)p_180680_3_.func_177229_b(field_176584_b)).booleanValue();
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      ...
      return this.func_176223_P().func_177226_a(field_176585_a, lvt_2_1_).func_177226_a(field_176584_b, Boolean.valueOf((p_176203_1_ & 8) > 0));
   }
