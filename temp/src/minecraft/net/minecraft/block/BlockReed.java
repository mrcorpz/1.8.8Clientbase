   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      if(p_180650_1_.func_180495_p(p_180650_2_.func_177977_b()).func_177230_c() == Blocks.field_150436_aH || this.func_176353_e(p_180650_1_, p_180650_2_, p_180650_3_)) {
         if(p_180650_1_.func_175623_d(p_180650_2_.func_177984_a())) {
            ...
            if(lvt_5_1_ < 3) {
               int lvt_6_1_ = ((Integer)p_180650_3_.func_177229_b(field_176355_a)).intValue();
               if(lvt_6_1_ == 15) {
                  ...
                  p_180650_1_.func_180501_a(p_180650_2_, p_180650_3_.func_177226_a(field_176355_a, Integer.valueOf(lvt_6_1_ + 1)), 4);
               }
            }
         }
   ...
   public boolean func_176196_c(World p_176196_1_, BlockPos p_176196_2_) {
      ...
      if(lvt_3_1_ == this) {
         ...
         for(EnumFacing lvt_5_1_ : EnumFacing.Plane.HORIZONTAL) {
            if(p_176196_1_.func_180495_p(p_176196_2_.func_177972_a(lvt_5_1_).func_177977_b()).func_177230_c().func_149688_o() == Material.field_151586_h) {
               return true;
            }
         }
