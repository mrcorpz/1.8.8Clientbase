...
public class BlockCake extends Block {
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      float lvt_4_1_ = (float)(1 + ((Integer)p_180654_1_.func_180495_p(p_180654_2_).func_177229_b(field_176589_a)).intValue() * 2) / 16.0F;
      float lvt_5_1_ = 0.5F;
   ...
   public AxisAlignedBB func_180640_a(World p_180640_1_, BlockPos p_180640_2_, IBlockState p_180640_3_) {
      ...
      float lvt_5_1_ = (float)(1 + ((Integer)p_180640_3_.func_177229_b(field_176589_a)).intValue() * 2) / 16.0F;
      float lvt_6_1_ = 0.5F;
   ...
   private void func_180682_b(World p_180682_1_, BlockPos p_180682_2_, IBlockState p_180682_3_, EntityPlayer p_180682_4_) {
      if(p_180682_4_.func_71043_e(false)) {
         ...
         int lvt_5_1_ = ((Integer)p_180682_3_.func_177229_b(field_176589_a)).intValue();
         if(lvt_5_1_ < 6) {
            p_180682_1_.func_180501_a(p_180682_2_, p_180682_3_.func_177226_a(field_176589_a, Integer.valueOf(lvt_5_1_ + 1)), 3);
         } else {
