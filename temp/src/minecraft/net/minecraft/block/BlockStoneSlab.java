...
public abstract class BlockStoneSlab extends BlockSlab {
   ...
   public BlockStoneSlab() {
      ...
      if(this.func_176552_j()) {
         lvt_1_1_ = lvt_1_1_.func_177226_a(field_176555_b, Boolean.valueOf(false));
      } else {
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      ...
      if(this.func_176552_j()) {
         lvt_2_1_ = lvt_2_1_.func_177226_a(field_176555_b, Boolean.valueOf((p_176203_1_ & 8) != 0));
      } else {
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | ((BlockStoneSlab.EnumType)p_176201_1_.func_177229_b(field_176556_M)).func_176624_a();
      if(this.func_176552_j()) {
