...
public class BlockStem extends BlockBush implements IGrowable {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      ...
      if(p_180650_1_.func_175671_l(p_180650_2_.func_177984_a()) >= 9) {
         ...
         if(p_180650_4_.nextInt((int)(25.0F / lvt_5_1_) + 1) == 0) {
            int lvt_6_1_ = ((Integer)p_180650_3_.func_177229_b(field_176484_a)).intValue();
            if(lvt_6_1_ < 7) {
               p_180650_3_ = p_180650_3_.func_177226_a(field_176484_a, Integer.valueOf(lvt_6_1_ + 1));
   ...
   public void func_176482_g(World p_176482_1_, BlockPos p_176482_2_, IBlockState p_176482_3_) {
      int lvt_4_1_ = ((Integer)p_176482_3_.func_177229_b(field_176484_a)).intValue() + MathHelper.func_76136_a(p_176482_1_.field_73012_v, 2, 5);
      p_176482_1_.func_180501_a(p_176482_2_, p_176482_3_.func_177226_a(field_176484_a, Integer.valueOf(Math.min(7, lvt_4_1_))), 2);
   }
   ...
   public int func_180644_h(IBlockState p_180644_1_) {
      if(p_180644_1_.func_177230_c() != this) {
         ...
         int lvt_2_1_ = ((Integer)p_180644_1_.func_177229_b(field_176484_a)).intValue();
   ...
   public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_) {
      ...
      if(!p_180653_1_.field_72995_K) {
         ...
         if(lvt_6_1_ != null) {
            int lvt_7_1_ = ((Integer)p_180653_3_.func_177229_b(field_176484_a)).intValue();
