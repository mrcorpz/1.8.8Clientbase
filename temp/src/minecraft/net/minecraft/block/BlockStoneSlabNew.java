...
public abstract class BlockStoneSlabNew extends BlockSlab {
   ...
   public BlockStoneSlabNew() {
      ...
      if(this.func_176552_j()) {
         lvt_1_1_ = lvt_1_1_.func_177226_a(field_176558_b, Boolean.valueOf(false));
      } else {
   ...
   public IBlockState func_176203_a(int p_176203_1_) {
      ...
      if(this.func_176552_j()) {
         lvt_2_1_ = lvt_2_1_.func_177226_a(field_176558_b, Boolean.valueOf((p_176203_1_ & 8) != 0));
      } else {
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | ((BlockStoneSlabNew.EnumType)p_176201_1_.func_177229_b(field_176559_M)).func_176915_a();
      if(this.func_176552_j()) {
