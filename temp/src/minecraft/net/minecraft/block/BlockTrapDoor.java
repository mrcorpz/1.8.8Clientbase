...
public class BlockTrapDoor extends Block {
      ...
      if(!p_176204_1_.field_72995_K) {
         ...
         if(!func_150119_a(p_176204_1_.func_180495_p(lvt_5_1_).func_177230_c())) {
            ...
            if(lvt_6_1_ || p_176204_4_.func_149744_f()) {
               boolean lvt_7_1_ = ((Boolean)p_176204_3_.func_177229_b(field_176283_b)).booleanValue();
               if(lvt_7_1_ != lvt_6_1_) {
                  p_176204_1_.func_180501_a(p_176204_2_, p_176204_3_.func_177226_a(field_176283_b, Boolean.valueOf(lvt_6_1_)), 2);
   ...
   public IBlockState func_180642_a(World p_180642_1_, BlockPos p_180642_2_, EnumFacing p_180642_3_, float p_180642_4_, float p_180642_5_, float p_180642_6_, int p_180642_7_, EntityLivingBase p_180642_8_) {
      ...
      if(p_180642_3_.func_176740_k().func_176722_c()) {
         lvt_9_1_ = lvt_9_1_.func_177226_a(field_176284_a, p_180642_3_).func_177226_a(field_176283_b, Boolean.valueOf(false));
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      int lvt_2_1_ = 0;
      lvt_2_1_ = lvt_2_1_ | func_176282_a((EnumFacing)p_176201_1_.func_177229_b(field_176284_a));
