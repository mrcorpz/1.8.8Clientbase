...
public class BlockRedstoneTorch extends BlockTorch {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      ...
      List<BlockRedstoneTorch.Toggle> lvt_6_1_ = (List)field_150112_b.get(p_180650_1_);
         ...
         if(lvt_5_1_) {
            ...
            if(this.func_176598_a(p_180650_1_, p_180650_2_, true)) {
               ...
               for(int lvt_7_1_ = 0; lvt_7_1_ < 5; ++lvt_7_1_) {
                  ...
                  p_180650_1_.func_175688_a(EnumParticleTypes.SMOKE_NORMAL, lvt_8_1_, lvt_10_1_, lvt_12_1_, 0.0D, 0.0D, 0.0D, new int[0]);
               }
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      if(this.field_150113_a) {
         ...
         p_180655_1_.func_175688_a(EnumParticleTypes.REDSTONE, lvt_5_1_, lvt_7_1_, lvt_9_1_, 0.0D, 0.0D, 0.0D, new int[0]);
      }
   }
