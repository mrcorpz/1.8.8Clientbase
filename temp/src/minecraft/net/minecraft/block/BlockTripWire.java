...
public class BlockTripWire extends Block {
   ...
   public void func_176204_a(World p_176204_1_, BlockPos p_176204_2_, IBlockState p_176204_3_, Block p_176204_4_) {
      boolean lvt_5_1_ = ((Boolean)p_176204_3_.func_177229_b(field_176290_b)).booleanValue();
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      boolean lvt_4_1_ = ((Boolean)lvt_3_1_.func_177229_b(field_176294_M)).booleanValue();
      boolean lvt_5_1_ = ((Boolean)lvt_3_1_.func_177229_b(field_176290_b)).booleanValue();
      if(!lvt_5_1_) {
   ...
   private void func_176288_d(World p_176288_1_, BlockPos p_176288_2_) {
      ...
      boolean lvt_4_1_ = ((Boolean)lvt_3_1_.func_177229_b(field_176293_a)).booleanValue();
      ...
      if(lvt_5_1_ != lvt_4_1_) {
         lvt_3_1_ = lvt_3_1_.func_177226_a(field_176293_a, Boolean.valueOf(lvt_5_1_));
   ...
   public static boolean func_176287_c(IBlockAccess p_176287_0_, BlockPos p_176287_1_, IBlockState p_176287_2_, EnumFacing p_176287_3_) {
      ...
      if(lvt_6_1_ == Blocks.field_150479_bC) {
         ...
         boolean lvt_7_2_ = ((Boolean)p_176287_2_.func_177229_b(field_176290_b)).booleanValue();
         boolean lvt_8_1_ = ((Boolean)lvt_5_1_.func_177229_b(field_176290_b)).booleanValue();
