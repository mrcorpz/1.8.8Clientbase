...
public class BlockCocoa extends BlockDirectional implements IGrowable {
   ...
   public void func_180650_b(World p_180650_1_, BlockPos p_180650_2_, IBlockState p_180650_3_, Random p_180650_4_) {
      if(!this.func_176499_e(p_180650_1_, p_180650_2_, p_180650_3_)) {
         ...
         int lvt_5_1_ = ((Integer)p_180650_3_.func_177229_b(field_176501_a)).intValue();
         if(lvt_5_1_ < 2) {
            p_180650_1_.func_180501_a(p_180650_2_, p_180650_3_.func_177226_a(field_176501_a, Integer.valueOf(lvt_5_1_ + 1)), 2);
         }
      }
   ...
   public void func_180654_a(IBlockAccess p_180654_1_, BlockPos p_180654_2_) {
      ...
      int lvt_5_1_ = ((Integer)lvt_3_1_.func_177229_b(field_176501_a)).intValue();
   ...
   public void func_180653_a(World p_180653_1_, BlockPos p_180653_2_, IBlockState p_180653_3_, float p_180653_4_, int p_180653_5_) {
      int lvt_6_1_ = ((Integer)p_180653_3_.func_177229_b(field_176501_a)).intValue();
      int lvt_7_1_ = 1;
      if(lvt_6_1_ >= 2) {
         lvt_7_1_ = 3;
      }
   ...
   public int func_176201_c(IBlockState p_176201_1_) {
      ...
      lvt_2_1_ = lvt_2_1_ | ((Integer)p_176201_1_.func_177229_b(field_176501_a)).intValue() << 2;
      return lvt_2_1_;
   }
