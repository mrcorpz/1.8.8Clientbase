...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      List<T> lvt_1_1_ = this.field_75380_a.field_70170_p.<T>func_175647_a(this.field_181064_i, this.field_75380_a.func_174813_aQ().func_72314_b((double)this.field_179508_f, 3.0D, (double)this.field_179508_f), Predicates.and(new Predicate[]{EntitySelectors.field_180132_d, this.field_179509_a, this.field_179510_i}));
      if(lvt_1_1_.isEmpty()) {
         return false;
      } else {
         ...
         if(lvt_2_1_ == null) {
            ...
            return this.field_75374_f == null?false:this.field_75374_f.func_75880_b(lvt_2_1_);
         }
      }
   }
